...
rem determine Fesen home; to do this, we strip from the path until we
...
%JAVA% -cp "%ES_CLASSPATH%" "org.codelibs.fesen.tools.java_version_checker.JavaVersionChecker" || exit /b 1
