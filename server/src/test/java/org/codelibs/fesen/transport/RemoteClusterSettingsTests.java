...
import static org.codelibs.fesen.test.NodeRoles.nonRemoteClusterClientNode;
import static org.codelibs.fesen.test.NodeRoles.remoteClusterClientNode;
import static org.codelibs.fesen.transport.RemoteClusterService.ENABLE_REMOTE_CLUSTERS;
import static org.codelibs.fesen.transport.RemoteClusterService.REMOTE_CLUSTER_SKIP_UNAVAILABLE;
import static org.codelibs.fesen.transport.RemoteClusterService.REMOTE_INITIAL_CONNECTION_TIMEOUT_SETTING;
import static org.codelibs.fesen.transport.RemoteClusterService.REMOTE_NODE_ATTRIBUTE;
import static org.codelibs.fesen.transport.RemoteClusterService.SEARCH_ENABLE_REMOTE_CLUSTERS;
import static org.codelibs.fesen.transport.RemoteClusterService.SEARCH_REMOTE_CLUSTER_SKIP_UNAVAILABLE;
import static org.codelibs.fesen.transport.RemoteClusterService.SEARCH_REMOTE_INITIAL_CONNECTION_TIMEOUT_SETTING;
import static org.codelibs.fesen.transport.RemoteClusterService.SEARCH_REMOTE_NODE_ATTRIBUTE;
import static org.codelibs.fesen.transport.SniffConnectionStrategy.REMOTE_CLUSTERS_PROXY;
import static org.codelibs.fesen.transport.SniffConnectionStrategy.REMOTE_CLUSTER_SEEDS;
import static org.codelibs.fesen.transport.SniffConnectionStrategy.REMOTE_CONNECTIONS_PER_CLUSTER;
import static org.codelibs.fesen.transport.SniffConnectionStrategy.SEARCH_REMOTE_CLUSTERS_PROXY;
import static org.codelibs.fesen.transport.SniffConnectionStrategy.SEARCH_REMOTE_CLUSTERS_SEEDS;
import static org.codelibs.fesen.transport.SniffConnectionStrategy.SEARCH_REMOTE_CONNECTIONS_PER_CLUSTER;
...
public class RemoteClusterSettingsTests extends ESTestCase {
    ...
    public void testInitialConnectTimeoutFallback() {
        ...
        assertThat(REMOTE_INITIAL_CONNECTION_TIMEOUT_SETTING.get(settings),
    ...
    public void testProxyFallback() {
        ...
        final Settings settings =
                Settings.builder().put(SEARCH_REMOTE_CLUSTERS_PROXY.getConcreteSettingForNamespace(alias).getKey(), value).build();
