...
public class IndexBalanceTests extends ESAllocationTestCase {
    ...
    public void testBalanceAllNodesStartedAddIndex() {
        ...
        Metadata updatedMetadata = Metadata.builder(clusterState.metadata()).put(IndexMetadata.builder("test1").settings(
        ...
        RoutingTable updatedRoutingTable =
                RoutingTable.builder(clusterState.routingTable()).addAsNew(updatedMetadata.index("test1")).build();
