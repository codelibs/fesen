...
public class PreferPrimaryAllocationTests extends ESAllocationTestCase {
    ...
    public void testPreferPrimaryAllocationOverReplicas() {
        ...
        AllocationService strategy = createAllocationService(Settings.builder()
                ...
                .put("cluster.routing.allocation.node_initial_primaries_recoveries", 1).build());
        ...
        Metadata metadata = Metadata.builder()
                ...
                .put(IndexMetadata.builder("test2").settings(settings(Version.CURRENT)).numberOfShards(10).numberOfReplicas(0)).build();
        ...
        metadata = Metadata.builder(clusterState.metadata())
                .put(IndexMetadata.builder("new_index").settings(settings(Version.CURRENT)).numberOfShards(4).numberOfReplicas(0)).build();
