...
public class ReconfiguratorTests extends ESTestCase {
    ...
    public void testAutoShrinking() {
        ...
        final VotingConfiguration finalConfig =
                reconfigurator.reconfigure(liveNodesSet, emptySet(), randomFrom(liveNodesSet), initialConfig);
    ...
    private void check(Set<DiscoveryNode> liveNodes, Set<String> retired, VotingConfiguration config, boolean autoShrinkVotingConfiguration,
            VotingConfiguration expectedConfig) {
    ...
    private void check(Set<DiscoveryNode> liveNodes, Set<String> retired, String masterId, VotingConfiguration config,
        ...
        assertEquals(new ParameterizedMessage("[liveNodes={}, retired={}, master={}, config={}, autoShrinkVotingConfiguration={}]",
                liveNodes, retired, master, config, autoShrinkVotingConfiguration).getFormattedMessage(), expectedConfig, adaptedConfig);
    }
    ...
    public void testDynamicSetting() {
        ...
        assertThat(reconfigurator.reconfigure(twoNodes, retired(), randomFrom(twoNodes), initialConfig), sameInstance(initialConfig)); // no quorum
        ...
        expectThrows(IllegalArgumentException.class, () -> clusterSettings
                .applySettings(Settings.builder().put(CLUSTER_AUTO_SHRINK_VOTING_CONFIGURATION.getKey(), "blah").build()));
    }
}
