...
import org.codelibs.fesen.cluster.routing.allocation.AbstractAllocationDecision;
...
public class AllocationDecisionTests extends ESTestCase {
    ...
    public void testFromDecisionType() {
        ...
        AllocationDecision expected =
                type == Type.NO ? AllocationDecision.NO : type == Type.THROTTLE ? AllocationDecision.THROTTLED : AllocationDecision.YES;
