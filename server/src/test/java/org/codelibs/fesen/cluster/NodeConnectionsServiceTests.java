...
import static org.codelibs.fesen.cluster.NodeConnectionsService.CLUSTER_NODE_RECONNECT_INTERVAL_SETTING;
...
public class NodeConnectionsServiceTests extends ESTestCase {
    ...
    public void testOnlyBlocksOnConnectionsToNewNodes() throws Exception {
        ...
        try {
            ...
            expectThrows(FesenTimeoutException.class, () -> future3.actionGet(timeValueMillis(scaledRandomIntBetween(1, 1000))));
            ...
            expectThrows(FesenTimeoutException.class, () -> future6.actionGet(timeValueMillis(scaledRandomIntBetween(1, 1000))));
    ...
    public void testDebugLogging() throws IllegalAccessException {
        ...
        try {
            appender.start();
            Loggers.addAppender(LogManager.getLogger("org.codelibs.fesen.cluster.NodeConnectionsService"), appender);
