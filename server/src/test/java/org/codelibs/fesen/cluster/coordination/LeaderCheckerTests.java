...
import org.codelibs.fesen.cluster.coordination.LeaderChecker.LeaderCheckRequest;
...
import static org.codelibs.fesen.cluster.coordination.LeaderChecker.LEADER_CHECK_ACTION_NAME;
...
public class LeaderCheckerTests extends ESTestCase {
    ...
    public void testLeaderCheckRequestEqualsHashcodeSerialization() {
        LeaderCheckRequest request =
                new LeaderCheckRequest(new DiscoveryNode(randomAlphaOfLength(10), buildNewFakeTransportAddress(), Version.CURRENT));
