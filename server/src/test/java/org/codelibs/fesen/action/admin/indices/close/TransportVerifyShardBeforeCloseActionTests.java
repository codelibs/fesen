...
import org.codelibs.fesen.action.support.replication.TransportReplicationAction.ConcreteShardRequest;
...
public class TransportVerifyShardBeforeCloseActionTests extends ESTestCase {
    ...
    public void testUnavailableShardsMarkedAsStale() throws Exception {
        ...
        ReplicationOperation<TransportVerifyShardBeforeCloseAction.ShardRequest, TransportVerifyShardBeforeCloseAction.ShardRequest, PrimaryResult> operation =
                new ReplicationOperation<>(request, createPrimary(primaryRouting, replicationGroup), listener, proxy, logger, threadPool,
                        "test", primaryTerm, TimeValue.timeValueMillis(20), TimeValue.timeValueSeconds(60));
        operation.execute();
    ...
    private static ReplicationOperation.Primary<TransportVerifyShardBeforeCloseAction.ShardRequest, TransportVerifyShardBeforeCloseAction.ShardRequest, PrimaryResult> createPrimary(
            final ShardRouting primary, final ReplicationGroup replicationGroup) {
