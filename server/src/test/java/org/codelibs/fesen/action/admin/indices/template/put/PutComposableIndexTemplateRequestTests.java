...
import org.codelibs.fesen.cluster.metadata.ComposableIndexTemplateTests;
...
public class PutComposableIndexTemplateRequestTests extends AbstractWireSerializingTestCase<PutComposableIndexTemplateAction.Request> {
    ...
    public void testPutGlobalTemplatesCannotHaveHiddenIndexSetting() {
        ...
        ComposableIndexTemplate globalTemplate =
                new ComposableIndexTemplate(org.codelibs.fesen.core.List.of("*"), template, null, null, null, null, null);
