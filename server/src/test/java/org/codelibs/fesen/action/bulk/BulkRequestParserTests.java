...
import org.codelibs.fesen.action.bulk.BulkRequestParser;
...
public class BulkRequestParserTests extends ESTestCase {
    ...
    public void testBarfOnLackOfTrailingNewline() {
        BytesArray request = new BytesArray("{ \"index\":{ \"_id\": \"bar\" } }\n{}");
        BulkRequestParser parser = new BulkRequestParser(randomBoolean());
        IllegalArgumentException e = expectThrows(IllegalArgumentException.class, () -> parser.parse(request, "foo", null, null, null, null,
                false, XContentType.JSON, indexRequest -> fail(), req -> fail(), req -> fail()));
    ...
    public void testFailOnExplicitIndex() {
        ...
        IllegalArgumentException ex = expectThrows(IllegalArgumentException.class, () -> parser.parse(request, null, null, null, null, null,
                false, XContentType.JSON, req -> fail(), req -> fail(), req -> fail()));
    ...
    public void testParseDeduplicatesParameterStrings() throws IOException {
        BytesArray request = new BytesArray("{ \"index\":{ \"_index\": \"bar\", \"pipeline\": \"foo\", \"routing\": \"blub\"} }\n{}\n"
