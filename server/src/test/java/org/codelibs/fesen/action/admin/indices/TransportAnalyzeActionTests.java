 ...
 * under the License.
 */
package org.codelibs.fesen.action.admin.indices;
...
import org.codelibs.fesen.indices.analysis.AnalysisModuleTests.AppendCharFilter;
...
public class TransportAnalyzeActionTests extends ESTestCase {
    ...
    public void setUp() throws Exception {
        ...
        Settings indexSettings = Settings.builder().put(IndexMetadata.SETTING_VERSION_CREATED, Version.CURRENT)
                ...
                .put("index.analysis.analyzer.custom_analyzer.filter", "mock").put("index.analysis.normalizer.my_normalizer.type", "custom")
                .put("index.analysis.char_filter.my_append.type", "append").put("index.analysis.char_filter.my_append.suffix", "baz")
                .put("index.analyze.max_token_count", 100).putList("index.analysis.normalizer.my_normalizer.filter", "lowercase").build();
    ...
    public void testGetIndexAnalyserWithoutIndexAnalyzers() {
        IllegalArgumentException e = expectThrows(IllegalArgumentException.class,
                () -> TransportAnalyzeAction.analyze(
                        new AnalyzeAction.Request().analyzer("custom_analyzer").text("the qu1ck brown fox-dog"), registry, null,
                        maxTokenCount));
    ...
    public void testUnknown() {
        ...
        IllegalArgumentException e = expectThrows(IllegalArgumentException.class,
                () -> TransportAnalyzeAction.analyze(new AnalyzeAction.Request().analyzer("foobar").text("the qu1ck brown fox"), registry,
                        notGlobal ? mockIndexService() : null, maxTokenCount));
        if (notGlobal) {
        ...
        e = expectThrows(IllegalArgumentException.class,
                () -> TransportAnalyzeAction.analyze(new AnalyzeAction.Request().tokenizer("foobar").text("the qu1ck brown fox"), registry,
                        notGlobal ? mockIndexService() : null, maxTokenCount));
        if (notGlobal) {
        ...
        e = expectThrows(IllegalArgumentException.class,
                () -> TransportAnalyzeAction.analyze(
                        new AnalyzeAction.Request().tokenizer("standard").addTokenFilter("foobar").text("the qu1ck brown fox"), registry,
                        notGlobal ? mockIndexService() : null, maxTokenCount));
        if (notGlobal) {
        ...
        e = expectThrows(IllegalArgumentException.class,
                () -> TransportAnalyzeAction.analyze(new AnalyzeAction.Request().tokenizer("standard").addTokenFilter("lowercase")
                        .addCharFilter("foobar").text("the qu1ck brown fox"), registry, notGlobal ? mockIndexService() : null,
                        maxTokenCount));
        if (notGlobal) {
        ...
        e = expectThrows(IllegalArgumentException.class,
                () -> TransportAnalyzeAction.analyze(new AnalyzeAction.Request().normalizer("foobar").text("the qu1ck brown fox"), registry,
                        mockIndexService(), maxTokenCount));
    ...
    public void testExceedDefaultMaxTokenLimit() {
        ...
        IllegalStateException e =
                expectThrows(IllegalStateException.class, () -> TransportAnalyzeAction.analyze(request, registry, null, maxTokenCount));
        ...
        IllegalStateException e2 =
                expectThrows(IllegalStateException.class, () -> TransportAnalyzeAction.analyze(request2, registry, null, maxTokenCount));
    ...
    public void testExceedSetMaxTokenLimit() {
        ...
        request.analyzer("standard");
        IllegalStateException e =
                expectThrows(IllegalStateException.class, () -> TransportAnalyzeAction.analyze(request, registry, null, idxMaxTokenCount));
        assertEquals(e.getMessage(), "The number of tokens produced by calling _analyze has exceeded the allowed maximum of ["
