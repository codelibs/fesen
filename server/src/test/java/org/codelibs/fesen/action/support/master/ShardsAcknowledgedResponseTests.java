...
public class ShardsAcknowledgedResponseTests extends ESTestCase {
    ...
    public void testSerialization() throws Exception {
        ...
        ShardsAcknowledgedResponse result = copyWriteable(testInstance, new NamedWriteableRegistry(Collections.emptyList()),
        ...
        result = copyWriteable(testInstance, new NamedWriteableRegistry(Collections.emptyList()), in -> new TestImpl(in, false, false),
                Version.CURRENT);
