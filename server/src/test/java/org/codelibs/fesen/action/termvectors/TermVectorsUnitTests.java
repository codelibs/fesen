...
public class TermVectorsUnitTests extends ESTestCase {
    ...
    public void testMultiParser() throws Exception {
        byte[] bytes = StreamsUtils.copyToBytesFromClasspath("/org/codelibs/fesen/action/termvectors/multiRequest1.json");
        ...
        bytes = StreamsUtils.copyToBytesFromClasspath("/org/codelibs/fesen/action/termvectors/multiRequest2.json");
    ...
    public void testMultiParserFilter() throws Exception {
        byte[] bytes = StreamsUtils.copyToBytesFromClasspath("/org/codelibs/fesen/action/termvectors/multiRequest3.json");
        XContentParser data = createParser(JsonXContent.jsonXContent, bytes);
        MultiTermVectorsRequest request = new MultiTermVectorsRequest();
        request.add(new TermVectorsRequest(), data);
