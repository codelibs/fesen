...
import static org.codelibs.fesen.index.get.GetResultTests.copyGetResult;
import static org.codelibs.fesen.index.get.GetResultTests.mutateGetResult;
import static org.codelibs.fesen.index.get.GetResultTests.randomGetResult;
    ...
    public void testToXContent() {
        ...
        }
        {
            GetResponse getResponse =
                    new GetResponse(new GetResult("index", "type", "id", UNASSIGNED_SEQ_NO, 0, 1, false, null, null, null));
            String output = Strings.toString(getResponse);
