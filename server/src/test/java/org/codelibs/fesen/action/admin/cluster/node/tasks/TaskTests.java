...
public class TaskTests extends ESTestCase {
    ...
    public void testTaskInfoToString() {
        ...
        TaskInfo taskInfo = new TaskInfo(new TaskId(nodeId, taskId), "test_type", "test_action", "test_description", null, startTime,
                runningTime, cancellable, TaskId.EMPTY_TASK_ID, Collections.singletonMap("foo", "bar"));
