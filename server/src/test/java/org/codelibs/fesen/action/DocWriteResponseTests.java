...
public class DocWriteResponseTests extends ESTestCase {
    public void testGetLocation() {
        final DocWriteResponse response = new DocWriteResponse(new ShardId("index", "uuid", 0), "type", "id",
                SequenceNumbers.UNASSIGNED_SEQ_NO, 17, 0, Result.CREATED) {
        };
    ...
    public void testGetLocationNonAscii() {
        final DocWriteResponse response = new DocWriteResponse(new ShardId("index", "uuid", 0), "type", "❤",
                SequenceNumbers.UNASSIGNED_SEQ_NO, 17, 0, Result.CREATED) {
        };
    ...
    public void testGetLocationWithSpaces() {
        final DocWriteResponse response = new DocWriteResponse(new ShardId("index", "uuid", 0), "type", "a b",
                SequenceNumbers.UNASSIGNED_SEQ_NO, 17, 0, Result.CREATED) {
        };
    ...
    public void testToXContentDoesntIncludeForcedRefreshUnlessForced() throws IOException {
        DocWriteResponse response = new DocWriteResponse(new ShardId("index", "uuid", 0), "type", "id", SequenceNumbers.UNASSIGNED_SEQ_NO,
                17, 0, Result.CREATED) {
