...
import org.codelibs.fesen.action.admin.indices.resolve.ResolveIndexAction.ResolvedAlias;
import org.codelibs.fesen.action.admin.indices.resolve.ResolveIndexAction.ResolvedDataStream;
import org.codelibs.fesen.action.admin.indices.resolve.ResolveIndexAction.ResolvedIndex;
import org.codelibs.fesen.action.admin.indices.resolve.ResolveIndexAction.Response;
...
import static org.codelibs.fesen.action.admin.indices.resolve.ResolveIndexAction.ResolvedDataStream.BACKING_INDICES_FIELD;
import static org.codelibs.fesen.action.admin.indices.resolve.ResolveIndexAction.ResolvedDataStream.TIMESTAMP_FIELD;
import static org.codelibs.fesen.action.admin.indices.resolve.ResolveIndexAction.ResolvedIndex.ALIASES_FIELD;
import static org.codelibs.fesen.action.admin.indices.resolve.ResolveIndexAction.ResolvedIndex.ATTRIBUTES_FIELD;
import static org.codelibs.fesen.action.admin.indices.resolve.ResolveIndexAction.ResolvedIndex.DATA_STREAM_FIELD;
import static org.codelibs.fesen.action.admin.indices.resolve.ResolveIndexAction.ResolvedIndexAbstraction.NAME_FIELD;
import static org.codelibs.fesen.action.admin.indices.resolve.ResolveIndexAction.Response.DATA_STREAMS_FIELD;
import static org.codelibs.fesen.action.admin.indices.resolve.ResolveIndexAction.Response.INDICES_FIELD;
...
public class ResolveIndexResponseTests extends AbstractSerializingTestCase<Response> {
    ...
    private static ResolvedIndex createTestResolvedIndexInstance() {
        ...
        String[] attributes = randomSubsetOf(org.codelibs.fesen.core.List.of("open", "hidden", "frozen")).toArray(Strings.EMPTY_ARRAY);
    ...
    private static final ConstructingObjectParser<ResolvedIndex, Void> INDEX_PARSER = new ConstructingObjectParser<>("resolved_index",
            args -> new ResolvedIndex((String) args[0],
    ...
    @SuppressWarnings("unchecked")
    private static final ConstructingObjectParser<Response, Void> RESPONSE_PARSER = new ConstructingObjectParser<>("resolve_index_response",
            args -> new Response((List<ResolvedIndex>) args[0], (List<ResolvedAlias>) args[1], (List<ResolvedDataStream>) args[2]));
    @SuppressWarnings("unchecked")
    private static final ConstructingObjectParser<ResolvedAlias, Void> ALIAS_PARSER = new ConstructingObjectParser<>("resolved_alias",
