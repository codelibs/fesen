...
public class ExplainResponseTests extends AbstractSerializingTestCase<ExplainResponse> {
    ...
    protected ExplainResponse createTestInstance() {
        ...
        GetResult getResult = new GetResult(randomAlphaOfLengthBetween(3, 10), randomAlphaOfLengthBetween(3, 10),
                randomAlphaOfLengthBetween(3, 10), 0, 1, randomNonNegativeLong(), true, RandomObjects.randomSource(random()),
    ...
    public void testToXContent() throws IOException {
        ...
        GetResult getResult =
                new GetResult(null, null, null, 0, 1, -1, true, new BytesArray("{ \"field1\" : " + "\"value1\", \"field2\":\"value2\"}"),
                        singletonMap("field1", new DocumentField("field1", singletonList("value1"))), null);
