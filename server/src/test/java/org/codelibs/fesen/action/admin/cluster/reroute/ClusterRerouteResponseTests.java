...
public class ClusterRerouteResponseTests extends ESTestCase {
    ...
    public void testToXContent() throws IOException {
        ...
        IndexMetadata indexMetadata = IndexMetadata.builder("index")
                .settings(Settings.builder().put(IndexSettings.INDEX_CHECK_ON_STARTUP.getKey(), true)
                        .put(IndexSettings.MAX_SCRIPT_FIELDS_SETTING.getKey(), 10).put(IndexMetadata.SETTING_NUMBER_OF_SHARDS, 1)
