...
import org.codelibs.fesen.common.settings.AbstractScopedSettings.SettingUpdater;
...
public class SettingTests extends ESTestCase {
    ...
    public void testByteSizeSettingMinValue() {
        final Setting<ByteSizeValue> byteSizeValueSetting = Setting.byteSizeSetting("a.byte.size", new ByteSizeValue(100, ByteSizeUnit.MB),
                new ByteSizeValue(20_000_000, ByteSizeUnit.BYTES), new ByteSizeValue(Integer.MAX_VALUE, ByteSizeUnit.BYTES));
    ...
    public void testByteSizeSettingMaxValue() {
        final Setting<ByteSizeValue> byteSizeValueSetting = Setting.byteSizeSetting("a.byte.size", new ByteSizeValue(100, ByteSizeUnit.MB),
                new ByteSizeValue(16, ByteSizeUnit.MB), new ByteSizeValue(Integer.MAX_VALUE, ByteSizeUnit.BYTES));
    ...
    public void testMemorySize() {
        Setting<ByteSizeValue> memorySizeValueSetting =
                Setting.memorySizeSetting("a.byte.size", new ByteSizeValue(1024), Property.Dynamic, Property.NodeScope);
        ...
        // assertEquals(new ByteSizeValue((int) (JvmInfo.jvmInfo().getMem().getHeapMax().getBytes() * 0.2)), value.get()); // FESEN skip
    }
    ...
    private static final Setting<String> FOO_BAR_SETTING =
            new Setting<>("foo.bar", "foobar", Function.identity(), new FooBarValidator(), Property.Dynamic, Property.NodeScope);
    ...
    public void testValidator() {
        final Settings settings = Settings.builder().put("foo.bar", "foo.bar value").put("baz.qux", "baz.qux value")
                .put("quux.quuz", "quux.quuz value").build();
    ...
    public void testFilteredFloatSetting() {
        final IllegalArgumentException e =
                expectThrows(IllegalArgumentException.class, () -> Setting.floatSetting("foo", 42.0f, 43.0f, Property.Filtered));
    ...
    public void testFilteredDoubleSetting() {
        final IllegalArgumentException e1 =
                expectThrows(IllegalArgumentException.class, () -> Setting.doubleSetting("foo", 42.0, 43.0, Property.Filtered));
        ...
        final IllegalArgumentException e2 =
                expectThrows(IllegalArgumentException.class, () -> Setting.doubleSetting("foo", 45.0, 43.0, 44.0, Property.Filtered));
    ...
    public void testFilteredIntSetting() {
        final IllegalArgumentException e1 =
                expectThrows(IllegalArgumentException.class, () -> Setting.intSetting("foo", 42, 43, 44, Property.Filtered));
        assertThat(e1, hasToString(containsString("Failed to parse value for setting [foo] must be >= 43")));

        final IllegalArgumentException e2 =
                expectThrows(IllegalArgumentException.class, () -> Setting.intSetting("foo", 45, 43, 44, Property.Filtered));
    ...
    public void testFilteredLongSetting() {
        final IllegalArgumentException e =
                expectThrows(IllegalArgumentException.class, () -> Setting.longSetting("foo", 42L, 43L, Property.Filtered));
    ...
    public void testFilteredTimeSetting() {
        ...
        final IllegalArgumentException e2 = expectThrows(IllegalArgumentException.class, () -> Setting.timeSetting("foo",
                TimeValue.timeValueHours(4), TimeValue.timeValueHours(2), TimeValue.timeValueHours(3), Property.Filtered));
    ...
    public void testGroups() {
        ...
        Settings currentInput =
                Settings.builder().put("foo.bar.1.value", "1").put("foo.bar.2.value", "2").put("foo.bar.3.value", "3").build();
    ...
    public void testFilteredGroups() {
        ...
        ClusterSettings.SettingUpdater<Settings> predicateSettingUpdater = setting.newUpdater(ref::set, logger, (s) -> assertFalse(true));
        IllegalArgumentException ex = expectThrows(IllegalArgumentException.class, () -> predicateSettingUpdater
                .apply(Settings.builder().put("foo.bar.1.value", "1").put("foo.bar.2.value", "2").build(), Settings.EMPTY));
    ...
    public void testListSettingsDeprecated() {
        final Setting<List<String>> deprecatedListSetting = Setting.listSetting("foo.deprecated",
                Collections.singletonList("foo.deprecated"), Function.identity(), Property.Deprecated, Property.NodeScope);
        final Setting<List<String>> nonDeprecatedListSetting = Setting.listSetting("foo.non_deprecated",
                Collections.singletonList("foo.non_deprecated"), Function.identity(), Property.NodeScope);
        final Settings settings = Settings.builder().put("foo.deprecated", "foo.deprecated1,foo.deprecated2")
                .put("foo.deprecated", "foo.non_deprecated1,foo.non_deprecated2").build();
    ...
    public void testListSettings() {
        Setting<List<String>> listSetting =
                Setting.listSetting("foo.bar", Arrays.asList("foo,bar"), (s) -> s.toString(), Property.Dynamic, Property.NodeScope);
        ...
        Setting<List<Integer>> otherSettings =
                Setting.listSetting("foo.bar", Collections.emptyList(), Integer::parseInt, Property.Dynamic, Property.NodeScope);
        ...
        Setting<List<String>> settingWithFallback =
                Setting.listSetting("foo.baz", listSetting, Function.identity(), Property.Dynamic, Property.NodeScope);
    ...
    public void testAffixSettingNamespaces() {
        Setting.AffixSetting<Boolean> setting =
                Setting.affixKeySetting("foo.", "enable", (key) -> Setting.boolSetting(key, false, Property.NodeScope));
        Settings build = Settings.builder().put("foo.bar.enable", "true").put("foo.baz.enable", "true").put("foo.boom.enable", "true")
                .put("something.else", "true").build();
    ...
    public void testGetAllConcreteSettings() {
        ...
        Settings settings = Settings.builder().putList("foo.1.bar", "1", "2").putList("foo.2.bar", "3", "4", "5").putList("foo.bar", "6")
                .putList("some.other", "6").putList("foo.3.bar", "6").build();
    ...
    public void testAffixSettingsValidatorDependencies() {
        ...
        assertEquals(fix1.get(Settings.builder().put("abc.3.def", 13).put("abc.1.def", 11).put("abc.2.def", 12).put("abc.qrx", 20).build()),
                Integer.valueOf(20));
    ...
    public void testRejectNullProperties() {
        IllegalArgumentException ex =
                expectThrows(IllegalArgumentException.class, () -> Setting.simpleString("foo.bar", (Property[]) null));
    ...
    public void testRejectConflictingDynamicAndFinalProperties() {
        IllegalArgumentException ex =
                expectThrows(IllegalArgumentException.class, () -> Setting.simpleString("foo.bar", Property.Final, Property.Dynamic));
    ...
    public void testRejectNonIndexScopedNotCopyableOnResizeSetting() {
        final IllegalArgumentException e =
                expectThrows(IllegalArgumentException.class, () -> Setting.simpleString("foo.bar", Property.NotCopyableOnResize));
    ...
    public void testRejectNonIndexScopedInternalIndexSetting() {
        final IllegalArgumentException e =
                expectThrows(IllegalArgumentException.class, () -> Setting.simpleString("foo.bar", Property.InternalIndex));
    ...
    public void testRejectNonIndexScopedPrivateIndexSetting() {
        final IllegalArgumentException e =
                expectThrows(IllegalArgumentException.class, () -> Setting.simpleString("foo.bar", Property.PrivateIndex));
    ...
    public void testTimeValueBounds() {
        ...
        Setting<TimeValue> settingWithBothBounds =
                Setting.timeSetting("bar", TimeValue.timeValueSeconds(10), TimeValue.timeValueSeconds(5), TimeValue.timeValueSeconds(20));
        ...
        illegalArgumentException = expectThrows(IllegalArgumentException.class,
    ...
    public void testSettingsGroupUpdater() {
        ...
        AbstractScopedSettings.SettingUpdater<Settings> updater =
                Setting.groupedSettingsUpdater(s -> {}, Arrays.asList(intSetting, intSetting2));
    ...
    public void testSettingsGroupUpdaterWithAffixSetting() {
        ...
        AbstractScopedSettings.SettingUpdater<Settings> updater =
                Setting.groupedSettingsUpdater(s -> {}, Arrays.asList(intSetting, prefixKeySetting, affixSetting));

        Settings.Builder currentSettingsBuilder = Settings.builder().put("prefix.foo.bar.baz", "foo").put("prefix.foo.infix.suffix", "foo");
        Settings.Builder previousSettingsBuilder =
                Settings.builder().put("prefix.foo.bar.baz", "foo").put("prefix.foo.infix.suffix", "foo");
        ...
        boolean expectedChange =
                removeAffixKeySetting || removePrefixKeySetting || changeAffixKeySetting || changePrefixKeySetting || removeAffixNamespace;
    ...
    public void testAffixNamespacesWithGroupSetting() {
        final Setting.AffixSetting<Settings> affixSetting = Setting.affixKeySetting("prefix.", "suffix",
    ...
    public void testGroupSettingUpdaterValidator() {
        final Setting.AffixSetting<Integer> affixSetting = Setting.affixKeySetting("prefix.", "suffix",
        ...
        AbstractScopedSettings.SettingUpdater<Settings> updater =
                Setting.groupedSettingsUpdater(s -> {}, Arrays.asList(affixSetting, fixSetting), validator);
        ...
        Settings s = updater.getValue(Settings.builder().put("prefix.foo.suffix", 5).put("prefix.bar.suffix", 5).put("abc", 3).build(),
                Settings.EMPTY);
        assertNotNull(s);
    }
    ...
    public void testAffixMapUpdateWithNullSettingValue() {
        ...
        final Setting.AffixSetting<String> affixSetting =
                Setting.prefixKeySetting("prefix" + ".", key -> Setting.simpleString(key, Property.Dynamic, Property.NodeScope));
    ...
    public void testNonSecureSettingInKeystore() {
        ...
        assertThat(e.getMessage(), containsString("must be stored inside fesen.yml"));
    }

    @TestLogging(value = "org.codelibs.fesen.common.settings.IndexScopedSettings:INFO", reason = "to ensure we log INFO-level messages from IndexScopedSettings")
    public void testLogSettingUpdate() throws Exception {
        final IndexMetadata metadata =
                newIndexMeta("index1", Settings.builder().put(IndexSettings.INDEX_REFRESH_INTERVAL_SETTING.getKey(), "20s").build());
        final IndexSettings settings = new IndexSettings(metadata, Settings.EMPTY);

        final MockLogAppender mockLogAppender = new MockLogAppender();
        mockLogAppender.addExpectation(
                new MockLogAppender.SeenEventExpectation("message", "org.codelibs.fesen.common.settings.IndexScopedSettings", Level.INFO,
