...
public class SettingsModuleTests extends ModuleTestCase {
    ...
    public void testRegisterConsistentSettings() {
        ...
        final Setting<?> concreteConsistentSetting =
        ...
        final Setting<?> concreteUnsecureConsistentSetting =
                Setting.simpleString("some.custom.UNSECURE.consistent.setting", Property.Consistent, Property.NodeScope);
        ...
        final Setting<?> afixConcreteConsistentSetting = Setting.affixKeySetting("some.custom.secure.consistent.afix.", "setting",
        ...
        final Setting<?> concreteUnsecureConsistentAfixSetting = Setting.affixKeySetting("some.custom.secure.consistent.afix.", "setting",
    ...
    public void testMutuallyExclusiveScopes() {
        ...
        try {
            new SettingsModule(Settings.EMPTY, Setting.simpleString("foo.bar", Property.IndexScope, Property.NodeScope),
