...
import static org.codelibs.fesen.common.io.Streams.copyToString;
import static org.hamcrest.Matchers.equalTo;

/**
 * Unit tests for {@link org.codelibs.fesen.common.io.Streams}.
 */
public class StreamsTests extends ESTestCase {
    ...
    public void testLimitInputStream() throws IOException {
        ...
        final long count = org.codelibs.fesen.core.internal.io.Streams.copy(Streams.limitStream(stuffArray.streamInput(), limit), out);
