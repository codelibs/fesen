...
import static org.codelibs.fesen.common.time.DateUtils.clampToNanosRange;
import static org.codelibs.fesen.common.time.DateUtils.toInstant;
import static org.codelibs.fesen.common.time.DateUtils.toLong;
import static org.codelibs.fesen.common.time.DateUtils.toMilliSeconds;
import static org.codelibs.fesen.common.time.DateUtils.toNanoSeconds;
import static org.hamcrest.Matchers.containsString;
import static org.hamcrest.Matchers.equalTo;
import static org.hamcrest.Matchers.is;

public class DateUtilsTests extends ESTestCase {
    private static final Set<String> IGNORE = new HashSet<>(Arrays.asList("Eire", "Europe/Dublin", // dublin timezone in joda does not account for DST
    ...
    public void testRoundQuarterOfYear() {
        ...
        ZonedDateTime randomZonedDateTime = ZonedDateTime.of(year, month, day, randomIntBetween(0, 23), randomIntBetween(0, 59),
                randomIntBetween(0, 59), 999_999_999, ZoneOffset.UTC);
