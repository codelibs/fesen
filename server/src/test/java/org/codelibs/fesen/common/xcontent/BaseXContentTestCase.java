...
import org.codelibs.fesen.common.xcontent.NamedObjectNotFoundException;
...
public abstract class BaseXContentTestCase extends ESTestCase {
    ...
    public void testDoubles() throws IOException {
        ...
        assertResult("{'double':[1.7976931348623157E308,4.9E-324]}",
    ...
    public void testFloats() throws IOException {
        ...
        assertResult("{'float':[3.4028235E38,1.4E-45]}",
    ...
    public void testIntegers() throws IOException {
        ...
        assertResult("{'integer':[2147483647,-2147483648]}",
    ...
    public void testLongs() throws IOException {
        ...
        assertResult("{'long':[2147483647,-2147483648]}",
    ...
    public void testDateField() throws Exception {
        ...
        assertResult("{'date':'2016-01-01T00:00:00.000Z','date_in_millis':1451606400000}",
    ...
    public void testObjects() throws Exception {
        ...
        objects.put("{'objects':[{'f1':'v1','f2':2,'f3':[3,4,5]},{'f1':'v1','f2':{'f1':'v1','f2':2,'f3':[3,4,5]}}]}",
                new Object[] { x1, x2 });
    ...
    public void testToXContent() throws Exception {
        ...
        assertResult(
                "{'root':{" + "'field':'value'," + "'array':['1','2','3']," + "'foo':{'bar':'baz'}" + "}," + "'childs':["
                        + "{'field':'value','array':['1','2','3'],'foo':{'bar':'baz'}}," + "{'field':'value','foo':{'bar':'baz'}}" + "]}",
    ...
    public void testUnknownObject() throws Exception {
        ...
        objects.put("{'obj':'class org.codelibs.fesen.common.xcontent.BaseXContentTestCase'}", BaseXContentTestCase.class);
    ...
    void doTestRawField(XContent source, boolean useStream) throws Exception {
        ...
        try (XContentParser parser = xcontentType().xContent().createParser(NamedXContentRegistry.EMPTY,
                DeprecationHandler.THROW_UNSUPPORTED_OPERATION, os.toByteArray())) {
    ...
    protected void doTestBigInteger(JsonGenerator generator, ByteArrayOutputStream os) throws Exception {
        ...
        try (XContentParser parser = xcontentType().xContent().createParser(NamedXContentRegistry.EMPTY,
                DeprecationHandler.THROW_UNSUPPORTED_OPERATION, serialized)) {
    ...
    public void testSelfReferencingObjectsArray() throws IOException {
        ...
        IllegalArgumentException e =
                expectThrows(IllegalArgumentException.class, () -> builder().startObject().field("field", values).endObject());
        assertThat(e.getMessage(), containsString("Iterable object is self-referencing itself"));
    ...
    public void testNamedObject() throws IOException {
        ...
        NamedXContentRegistry registry =
                new NamedXContentRegistry(Arrays.asList(new NamedXContentRegistry.Entry(Object.class, new ParseField("test1"), p -> test1),
        ...
        try (XContentParser p = xcontentType().xContent().createParser(registry, LoggingDeprecationHandler.INSTANCE,
            ...
            {
                NamedObjectNotFoundException e =
                        expectThrows(NamedObjectNotFoundException.class, () -> p.namedObject(Object.class, "unknown", null));
        ...
        try (XContentParser emptyRegistryParser = xcontentType().xContent().createParser(NamedXContentRegistry.EMPTY,
                DeprecationHandler.THROW_UNSUPPORTED_OPERATION, new byte[] {})) {
            Exception e =
                    expectThrows(XContentParseException.class, () -> emptyRegistryParser.namedObject(String.class, "doesn't matter", null));
