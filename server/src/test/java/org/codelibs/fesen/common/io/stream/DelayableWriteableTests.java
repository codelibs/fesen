...
import org.codelibs.fesen.common.io.stream.DelayableWriteable;
...
public class DelayableWriteableTests extends ESTestCase {
    ...
    private <T extends Writeable> DelayableWriteable<T> roundTrip(DelayableWriteable<T> original, Writeable.Reader<T> reader,
            Version version) throws IOException {
        return copyInstance(original, writableRegistry(), (out, d) -> d.writeTo(out), in -> DelayableWriteable.delayed(reader, in),
                version);
    }
