...
import static org.codelibs.fesen.common.logging.HeaderWarning.WARNING_HEADER_PATTERN;
...
public class HeaderWarningTests extends ESTestCase {
    ...
    public void testSurrogatePair() throws IOException {
        ...
        final int[] points =
                new int[] { (code >> 18) & 0x07 | 0xF0, (code >> 12) & 0x3F | 0x80, (code >> 6) & 0x3F | 0x80, (code >> 0) & 0x3F | 0x80 };
