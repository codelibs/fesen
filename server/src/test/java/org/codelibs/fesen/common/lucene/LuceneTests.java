...
import org.codelibs.fesen.index.fielddata.fieldcomparator.FloatValuesComparatorSource;
...
public class LuceneTests extends ESTestCase {
    ...
    private static Tuple<SortField, SortField> randomSortFieldCustomComparatorSource() {
        ...
        case 0:
            comparatorSource =
                    new LongValuesComparatorSource(null, randomBoolean() ? randomLong() : null, randomFrom(MultiValueMode.values()), null);
            break;
        case 1:
        ...
        case 2:
            ...
            break;
        case 3:
            comparatorSource = new BytesRefFieldComparatorSource(null, randomBoolean() ? "_first" : "_last",
                    randomFrom(MultiValueMode.values()), null);
