...
package org.codelibs.fesen.common.util.set;
...
public class SetsTests extends ESTestCase {
    ...
    public void testIntersection() {
        ...
        final Set<Integer> expectedIntersection = IntStream.range(0, endExclusive).boxed()
                .filter(i -> (sets.v1().contains(i) && sets.v2().contains(i))).collect(Collectors.toSet());
