...
public class XContentMapValuesTests extends AbstractFilteringTestCase {
    ...
    protected void testFilter(Builder expected, Builder actual, Set<String> includes, Set<String> excludes) throws IOException {
        ...
        assertEquals("Filtered map must be equal to the expected map", toMap(expected, xContentType, humanReadable),
    ...
    public void testExtractValue() throws Exception {
        ...
        builder = XContentFactory.jsonBuilder().startObject().startObject("path1").startObject("path2").field("test", "value").endObject()
                .endObject().endObject();
        ...
        // lists
        builder =
                XContentFactory.jsonBuilder().startObject().startObject("path1").array("test", "value1", "value2").endObject().endObject();
        ...
        builder = XContentFactory.jsonBuilder().startObject().startObject("path1").startArray("path2").startObject().field("test", "value1")
        ...
        builder = XContentFactory.jsonBuilder().startObject().startObject("path1.xxx").startObject("path2.yyy").field("test", "value")
    ...
    public void testExtractValueWithNullValue() throws Exception {
        XContentBuilder builder = XContentFactory.jsonBuilder().startObject().field("field", "value").nullField("other_field")
                .array("array", "value1", null, "value2").startObject("object1").startObject("object2").nullField("field").endObject()
                .endObject().startArray("object_array").startObject().nullField("field").endObject().startObject().field("field", "value")
        ...
        assertEquals(org.codelibs.fesen.core.List.of("value1", "NULL", "value2"), XContentMapValues.extractValue("array", map, "NULL"));
        assertEquals(org.codelibs.fesen.core.List.of("NULL", "value"), XContentMapValues.extractValue("object_array.field", map, "NULL"));
    ...
    public void testThatFilterIncludesEmptyObjectWhenUsingExcludes() throws Exception {
        ...
        Map<String, Object> filteredSource =
                XContentMapValues.filter(mapTuple.v2(), Strings.EMPTY_ARRAY, new String[] { "nonExistingField" });
    ...
    public void testNotOmittingObjectWithNestedExcludedObject() throws Exception {
        XContentBuilder builder = XContentFactory.jsonBuilder().startObject().startObject("obj1").startObject("obj2").startObject("obj3")
    ...
    public void testIncludingObjectWithNestedIncludedObject() throws Exception {
        XContentBuilder builder =
                XContentFactory.jsonBuilder().startObject().startObject("obj1").startObject("obj2").endObject().endObject().endObject();
