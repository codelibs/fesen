...
public class GeoWKTShapeParserTests extends BaseGeoParsingTestCase {
    ...
    public void testParsePoint() throws IOException, ParseException {
        ...
        assertExpected(new org.codelibs.fesen.geometry.Point(p.lon(), p.lat()), new PointBuilder().coordinate(c), false);
    ...
    public void testParseMultiPoint() throws IOException, ParseException {
        ...
        List<org.codelibs.fesen.geometry.Point> points = new ArrayList<>(numPoints);
        for (int i = 0; i < numPoints; ++i) {
            Coordinate c = coordinates.get(i);
            points.add(new org.codelibs.fesen.geometry.Point(c.x, c.y));
        }
    ...
    public void testParsePolygon() throws IOException, ParseException {
        PolygonBuilder builder =
                PolygonBuilder.class.cast(RandomShapeGenerator.createShape(random(), RandomShapeGenerator.ShapeType.POLYGON));
    ...
    public void testParseMixedDimensionPolyWithHole() throws IOException, ParseException {
        ...
        Settings indexSettings = Settings.builder().put(IndexMetadata.SETTING_VERSION_CREATED, Version.V_7_0_0)
        ...
        FesenParseException e = expectThrows(FesenParseException.class, () -> ShapeParser.parse(parser, mapperBuilder));
    ...
    public void testParseMixedDimensionPolyWithHoleStoredZ() throws IOException {
        ...
        // test store z disabled
        FesenException e = expectThrows(FesenException.class, () -> ShapeParser.parse(parser, mapperBuilder));
    ...
    public void testParseOpenPolygon() throws IOException {
        ...
        FesenParseException exception = expectThrows(FesenParseException.class, () -> ShapeParser.parse(parser, defaultMapperBuilder));
    ...
    public void testParseEnvelope() throws IOException, ParseException {
        ...
        assertExpected(expected, builder, true);
        assertExpected(new org.codelibs.fesen.geometry.Rectangle(r.minLon, r.maxLon, r.maxLat, r.minLat), builder, false);
        assertMalformed(builder);
    }
    ...
    public void testUnexpectedShapeException() throws IOException {
        ...
        parser.nextToken();
        FesenParseException e = expectThrows(FesenParseException.class, () -> GeoWKTParser.parseExpectedType(parser, GeoShapeType.POLYGON));
