...
public class FesenGeoAssertions {
    ...
    public static void assertEquals(Object s1, Object s2) {
        ...
        } else if (s1 instanceof org.codelibs.fesen.geometry.Geometry && s2 instanceof org.codelibs.fesen.geometry.Geometry) {
            Assert.assertEquals(s1, s2);
        } else {
    ...
    public static void assertMultiPolygon(Object shape, boolean useJTS) {
        if (useJTS) {
            ...
            assertTrue("expected Polygon[] but found " + shape.getClass().getName(),
                    shape instanceof org.codelibs.fesen.geometry.MultiPolygon);
        }
    }
    ...
    public static void assertPolygon(Object shape, boolean useJTS) {
        if (useJTS) {
            ...
            assertTrue("expected Polygon but found " + shape.getClass().getName(), shape instanceof org.codelibs.fesen.geometry.Polygon);
        }
    }
    ...
    public static void assertMultiLineString(Object shape, boolean useJTS) {
        if (useJTS) {
            assertTrue("expected MultiLineString but found " + unwrapJTS(shape).getClass().getName(),
