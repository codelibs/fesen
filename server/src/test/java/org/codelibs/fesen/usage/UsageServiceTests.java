...
package org.codelibs.fesen.usage;
...
public class UsageServiceTests extends ESTestCase {
    ...
    /**
     * Test that we can not add a null reference to a {@link org.codelibs.fesen.rest.RestHandler} to the {@link UsageService}.
     */
    ...
    /**
     * Test that we can not add an instance of a {@link org.codelibs.fesen.rest.RestHandler} with no name to the {@link UsageService}.
     */
    ...
    /**
     * Test that we can add the same instance of a {@link org.codelibs.fesen.rest.RestHandler} to the {@link UsageService} multiple times.
     */
    ...
    /**
     * Test that we can not add different instances of {@link org.codelibs.fesen.rest.RestHandler} with the same name to the
     * {@link UsageService}.
     */
