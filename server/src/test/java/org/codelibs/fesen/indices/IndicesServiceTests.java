...
import org.codelibs.fesen.indices.IndicesService.ShardDeletionCheckResult;
...
import org.codelibs.fesen.test.hamcrest.RegexMatcher;
...
public class IndicesServiceTests extends ESSingleNodeTestCase {
    ...
    public void testIsMetadataField() {
        IndicesService indicesService = getIndicesService();
        final Version randVersion = VersionUtils.randomVersionBetween(random(), Version.V_7_0_0, Version.CURRENT);
