...
import org.codelibs.fesen.cluster.shards.ShardCounts;
...
import static org.codelibs.fesen.cluster.metadata.MetadataIndexStateServiceTests.addClosedIndex;
import static org.codelibs.fesen.cluster.metadata.MetadataIndexStateServiceTests.addOpenedIndex;
import static org.codelibs.fesen.cluster.shards.ShardCounts.forDataNodeCount;
import static org.codelibs.fesen.indices.ShardLimitValidator.SETTING_CLUSTER_MAX_SHARDS_PER_NODE;
