...
import org.codelibs.fesen.indices.recovery.RecoveryState.FileDetail;
import org.codelibs.fesen.indices.recovery.RecoveryState.Index;
import org.codelibs.fesen.indices.recovery.RecoveryState.Stage;
import org.codelibs.fesen.indices.recovery.RecoveryState.Timer;
import org.codelibs.fesen.indices.recovery.RecoveryState.Translog;
import org.codelibs.fesen.indices.recovery.RecoveryState.VerifyIndex;
...
public class RecoveryTargetTests extends ESTestCase {
    ...
    public void testStageSequenceEnforcement() {
        ...
        ShardRouting shardRouting = TestShardRouting.newShardRouting(new ShardId("bla", "_na_", 0), discoveryNode.getId(), randomBoolean(),
