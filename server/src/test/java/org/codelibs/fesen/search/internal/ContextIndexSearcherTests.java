...
import org.codelibs.fesen.search.internal.ExitableDirectoryReader;
...
import static org.codelibs.fesen.search.internal.ContextIndexSearcher.intersectScorerAndBitSet;
import static org.codelibs.fesen.search.internal.ExitableDirectoryReader.ExitableLeafReader;
import static org.codelibs.fesen.search.internal.ExitableDirectoryReader.ExitablePointValues;
import static org.codelibs.fesen.search.internal.ExitableDirectoryReader.ExitableTerms;
...
public class ContextIndexSearcherTests extends ESTestCase {
    public void testIntersectScorerAndRoleBits() throws Exception {
        ...
        Weight weight = searcher.createWeight(new BoostQuery(new ConstantScoreQuery(new TermQuery(new Term("field2", "value1"))), 3f),
    ...
    public void doTestContextIndexSearcher(boolean sparse, boolean deletions) throws IOException {
        ...
        DirectoryReader reader = FesenDirectoryReader.wrap(DirectoryReader.open(w), new ShardId(settings.getIndex(), 0));
