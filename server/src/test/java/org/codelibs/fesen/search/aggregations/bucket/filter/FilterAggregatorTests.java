...
import org.codelibs.fesen.search.aggregations.bucket.filter.FilterAggregator;
    ...
    public void testBucketComparator() throws IOException {
        try (Directory directory = newDirectory()) {
            ...
            try (IndexReader indexReader = DirectoryReader.open(directory)) {
                ...
                assertThat(c.compare(1, 0), lessThan(0));
                Exception e =
                        expectThrows(IllegalArgumentException.class, () -> agg.bucketComparator("garbage", randomFrom(SortOrder.values())));
