...
import static org.codelibs.fesen.search.aggregations.MultiBucketConsumerService.DEFAULT_MAX_BUCKETS;
    ...
    public BucketsAggregator buildMergeAggregator() throws IOException {
        try (Directory directory = newDirectory()) {
            ...
            try (IndexReader indexReader = DirectoryReader.open(directory)) {
                ...
                SearchContext searchContext = createSearchContext(indexSearcher, createIndexSettings(), null,
