...
import org.codelibs.fesen.search.suggest.completion.RegexOptions;
...
public class RegexOptionsTests extends ESTestCase {
    ...
    public void testSerialization() throws IOException {
        for (int i = 0; i < NUMBER_OF_RUNS; i++) {
            ...
            RegexOptions deserializedModel =
                    copyWriteable(testOptions, new NamedWriteableRegistry(Collections.emptyList()), RegexOptions::new);
