...
import org.codelibs.fesen.index.get.GetResultTests;
import org.codelibs.fesen.index.shard.ShardId;
import org.codelibs.fesen.search.SearchHit;
import org.codelibs.fesen.search.SearchHits;
import org.codelibs.fesen.search.SearchShardTarget;
import org.codelibs.fesen.search.SearchHit.NestedIdentity;
import org.codelibs.fesen.search.fetch.subphase.highlight.HighlightField;
import org.codelibs.fesen.search.fetch.subphase.highlight.HighlightFieldTests;
...
public class SearchHitTests extends AbstractWireSerializingTestCase<SearchHit> {
    ...
    public void testSerializeShardTarget() throws Exception {
        ...
        SearchShardTarget target =
                new SearchShardTarget("_node_id", new ShardId(new Index("_index", "_na_"), 0), clusterAlias, OriginalIndices.NONE);
