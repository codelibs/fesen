...
public class KeywordTermsAggregatorTests extends AggregatorTestCase {
    ...
    public void testMatchNoDocs() throws IOException {
        testSearchCase(new MatchNoDocsQuery(), dataset, aggregation -> aggregation.field(KEYWORD_FIELD),
    ...
    private void testSearchCase(Query query, List<String> dataset, Consumer<TermsAggregationBuilder> configure,
