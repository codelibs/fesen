...
public class StatsBucketTests extends AbstractBucketMetricsTestCase<StatsBucketPipelineAggregationBuilder> {
    ...
    public void testValidate() {
        ...
        assertThat(validate(aggBuilders, new StatsBucketPipelineAggregationBuilder("name", "invalid_agg>metric")),
        ...
        assertThat(validate(aggBuilders, new StatsBucketPipelineAggregationBuilder("name", "global>metric")),
