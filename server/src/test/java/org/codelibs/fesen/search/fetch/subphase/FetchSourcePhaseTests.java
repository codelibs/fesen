...
public class FetchSourcePhaseTests extends ESTestCase {
    ...
    public void testNestedSource() throws IOException {
        ...
        XContentBuilder source = XContentFactory.jsonBuilder().startObject().field("field", "value").field("field2", "value2")
                .field("nested1", expectedNested).endObject();
    ...
    public void testSourceDisabled() throws IOException {
        ...
        assertEquals("unable to fetch fields from _source field: _source is disabled in the mappings " + "for index [index]",
    ...
    private HitContext hitExecute(XContentBuilder source, boolean fetchSource, String include, String exclude,
        ...
        return hitExecuteMultiple(source, fetchSource, include == null ? Strings.EMPTY_ARRAY : new String[] { include },
