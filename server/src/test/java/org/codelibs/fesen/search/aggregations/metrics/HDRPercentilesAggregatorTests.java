...
import org.codelibs.fesen.search.aggregations.metrics.HDRPercentilesAggregator;
...
import org.codelibs.fesen.search.aggregations.metrics.PercentilesConfig;
import org.codelibs.fesen.search.aggregations.metrics.PercentilesMethod;
...
import static org.codelibs.fesen.search.aggregations.AggregationBuilders.percentiles;
...
public class HDRPercentilesAggregatorTests extends AggregatorTestCase {
    ...
    public void testHdrThenTdigestSettings() throws Exception {
        ...
        IllegalArgumentException e = expectThrows(IllegalArgumentException.class, () -> {
            percentiles("percentiles").numberOfSignificantValueDigits(sigDigits).method(PercentilesMethod.HDR).compression(100.0) // <-- this should trigger an exception
                    .field("value");
        });
    ...
    private void testCase(Query query, CheckedConsumer<RandomIndexWriter, IOException> buildIndex, Consumer<InternalHDRPercentiles> verify,
            MappedFieldType fieldType, String fieldName) throws IOException {
