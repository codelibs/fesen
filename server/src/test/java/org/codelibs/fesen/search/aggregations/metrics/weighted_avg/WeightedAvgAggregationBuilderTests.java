...
package org.codelibs.fesen.search.aggregations.metrics.weighted_avg;
...
public class WeightedAvgAggregationBuilderTests extends AbstractSerializingTestCase<WeightedAvgAggregationBuilder> {
    ...
    protected WeightedAvgAggregationBuilder createTestInstance() {
        ...
        WeightedAvgAggregationBuilder aggregationBuilder =
                new WeightedAvgAggregationBuilder(aggregationName).value(valueConfig).weight(weightConfig);
