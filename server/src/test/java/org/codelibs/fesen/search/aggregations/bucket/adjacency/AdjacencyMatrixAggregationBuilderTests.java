...
import org.codelibs.fesen.search.aggregations.bucket.adjacency.AdjacencyMatrixAggregatorFactory;
...
public class AdjacencyMatrixAggregationBuilderTests extends ESTestCase {
    ...
    public void testFilterSizeLimitation() throws Exception {
        ...
        assertWarnings("[index.max_adjacency_matrix_filters] setting was deprecated in Fesen and will be "
