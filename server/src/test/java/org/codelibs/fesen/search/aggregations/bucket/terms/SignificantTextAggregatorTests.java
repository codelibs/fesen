...
import static org.codelibs.fesen.search.aggregations.AggregationBuilders.sampler;
import static org.codelibs.fesen.search.aggregations.AggregationBuilders.significantText;
...
public class SignificantTextAggregatorTests extends AggregatorTestCase {
    ...
    protected List<ValuesSourceType> getSupportedValuesSourceTypes() {
        ...
        return Arrays.asList(CoreValuesSourceType.NUMERIC, CoreValuesSourceType.BYTES, CoreValuesSourceType.RANGE,
                CoreValuesSourceType.GEOPOINT);
    }

    @Override
    protected List<String> unsupportedMappedFieldTypes() {
        return Arrays.asList(BinaryFieldMapper.CONTENT_TYPE, // binary fields are not supported because they do not have analyzers
    ...
    public void testFieldAlias() throws IOException {
        ...
        try (Directory dir = newDirectory(); IndexWriter w = new IndexWriter(dir, indexWriterConfig)) {
            ...
            try (IndexReader reader = DirectoryReader.open(w)) {
                ...
                InternalSampler aliasSampler =
                        searchAndReduce(searcher, new TermQuery(new Term("text", "odd")), aliasSamplerAgg, textFieldType);
