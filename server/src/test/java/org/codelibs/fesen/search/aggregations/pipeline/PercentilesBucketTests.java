...
public class PercentilesBucketTests extends AbstractBucketMetricsTestCase<PercentilesBucketPipelineAggregationBuilder> {
    ...
    public void testPercentsFromMixedArray() throws Exception {
        XContentBuilder content = XContentFactory.jsonBuilder().startObject().startObject("name").startObject("percentiles_bucket")
                .field("buckets_path", "test").array("percents", 0, 20.0, 50, 75.99).endObject().endObject().endObject();
    ...
    public void testValidate() {
        ...
        assertThat(validate(aggBuilders, new PercentilesBucketPipelineAggregationBuilder("name", "invalid_agg>metric")),
        ...
        assertThat(validate(aggBuilders, new PercentilesBucketPipelineAggregationBuilder("name", "global>metric")),
