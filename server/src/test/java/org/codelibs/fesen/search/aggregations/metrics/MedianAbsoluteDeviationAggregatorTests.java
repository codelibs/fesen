...
import static org.codelibs.fesen.search.aggregations.metrics.MedianAbsoluteDeviationAggregatorTests.ExactMedianAbsoluteDeviation.calculateMAD;
import static org.codelibs.fesen.search.aggregations.metrics.MedianAbsoluteDeviationAggregatorTests.IsCloseToRelative.closeToRelative;
...
public class MedianAbsoluteDeviationAggregatorTests extends AggregatorTestCase {
    ...
    private static <T extends IndexableField> CheckedConsumer<RandomIndexWriter, IOException> randomSample(int size,
    ...
    public void testUnmapped() throws IOException {
        MedianAbsoluteDeviationAggregationBuilder aggregationBuilder =
                new MedianAbsoluteDeviationAggregationBuilder("foo").field(FIELD_NAME);
    ...
    public void testUnmappedMissing() throws IOException {
        MedianAbsoluteDeviationAggregationBuilder aggregationBuilder =
                new MedianAbsoluteDeviationAggregationBuilder("foo").field(FIELD_NAME).missing(1234);
    ...
    public void testValueScript() throws IOException {
        ...
        MedianAbsoluteDeviationAggregationBuilder aggregationBuilder = new MedianAbsoluteDeviationAggregationBuilder("foo")
                .field(FIELD_NAME).script(new Script(ScriptType.INLINE, MockScriptEngine.NAME, VALUE_SCRIPT, Collections.emptyMap()));
    ...
    private void testAggregation(Query query, CheckedConsumer<RandomIndexWriter, IOException> buildIndex,
        ...
        MedianAbsoluteDeviationAggregationBuilder builder =
                new MedianAbsoluteDeviationAggregationBuilder("mad").field(FIELD_NAME).compression(randomDoubleBetween(20, 1000, true));
    ...
    private void testAggregation(AggregationBuilder aggregationBuilder, Query query,
            CheckedConsumer<RandomIndexWriter, IOException> indexer, Consumer<InternalMedianAbsoluteDeviation> verify,
