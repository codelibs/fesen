...
import org.codelibs.fesen.search.aggregations.metrics.TDigestPercentilesAggregator;
...
public class TDigestPercentilesAggregatorTests extends AggregatorTestCase {
    ...
    public void testTdigestThenHdrSettings() throws Exception {
        ...
        IllegalArgumentException e = expectThrows(IllegalArgumentException.class, () -> {
            percentiles("percentiles").compression(100.0).method(PercentilesMethod.TDIGEST).numberOfSignificantValueDigits(sigDigits) // <-- this should trigger an exception
                    .field("value");
        });
