...
import static org.codelibs.fesen.search.aggregations.metrics.InternalPercentilesTestCase.randomPercents;
...
public class InternalPercentilesBucketTests extends InternalAggregationTestCase<InternalPercentilesBucket> {
    ...
    private static InternalPercentilesBucket createTestInstance(String name, Map<String, Object> metadata, double[] percents,
            boolean keyed) {
    ...
    private static InternalPercentilesBucket createTestInstance(String name, Map<String, Object> metadata, double[] percents,
            double[] percentiles, boolean keyed) {
