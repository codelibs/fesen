    ...
    protected FiltersAggregationBuilder createTestAggregatorBuilder() {
        ...
        if (randomBoolean()) {
            ...
            for (String key : randomUnique(() -> randomAlphaOfLengthBetween(1, 20), size)) {
                filters[i++] =
                        new KeyedFilter(key, QueryBuilders.termQuery(randomAlphaOfLengthBetween(5, 20), randomAlphaOfLengthBetween(5, 20)));
            }
    ...
    public void testEmptyFilters() throws IOException {
        {
            ...
            IllegalArgumentException e =
                    expectThrows(IllegalArgumentException.class, () -> FiltersAggregationBuilder.parse("agg_name", parser));
