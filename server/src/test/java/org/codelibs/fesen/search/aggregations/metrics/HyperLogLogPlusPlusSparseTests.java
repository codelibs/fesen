...
import org.codelibs.fesen.search.aggregations.metrics.AbstractCardinalityAlgorithm;
import org.codelibs.fesen.search.aggregations.metrics.AbstractHyperLogLogPlusPlus;
import org.codelibs.fesen.search.aggregations.metrics.AbstractLinearCounting;
import org.codelibs.fesen.search.aggregations.metrics.HyperLogLogPlusPlus;
import org.codelibs.fesen.search.aggregations.metrics.HyperLogLogPlusPlusSparse;
...
import static org.codelibs.fesen.search.aggregations.metrics.AbstractHyperLogLog.MAX_PRECISION;
import static org.codelibs.fesen.search.aggregations.metrics.AbstractHyperLogLog.MIN_PRECISION;
...
public class HyperLogLogPlusPlusSparseTests extends ESTestCase {
    ...
    private void checkEquivalence(AbstractHyperLogLogPlusPlus first, int firstBucket, AbstractHyperLogLogPlusPlus second,
            int secondBucket) {
