...
public class FsProbeTests extends ESTestCase {
    ...
    private void addUntilOverflow(final FsInfo.Path pathStats, final Function<FsInfo.Path, Long> getter, final String field,
        ...
        while ((getter.apply(pathStats) + getter.apply(pathToAdd)) > 0) {
            ...
            logger.info("--> adding {} bytes to {}, {} will be: {}", getter.apply(pathToAdd), getter.apply(pathStats), field,
    ...
    public void testIoStats() {
        ...
        diskStats.set(Arrays.asList(" 259       0 nvme0n1 336609 0 7923613 82813 10264051 0 182983933 52451441 0 2970886 52536260",
                " 259       1 nvme0n1p1 602 0 9919 131 1 0 1 0 0 19 131", " 259       2 nvme0n1p2 186 0 8626 18 24 0 60 20 0 34 38",
        ...
        diskStats.set(Arrays.asList(" 259       0 nvme0n1 336870 0 7928397 82876 10264393 0 182986405 52451610 0 2971042 52536492",
                " 259       1 nvme0n1p1 602 0 9919 131 1 0 1 0 0 19 131", " 259       2 nvme0n1p2 186 0 8626 18 24 0 60 20 0 34 38",
