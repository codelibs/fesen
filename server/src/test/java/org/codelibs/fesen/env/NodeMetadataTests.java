...
public class NodeMetadataTests extends ESTestCase {
    ...
    public void testUpgradesLegitimateVersions() {
        ...
        final NodeMetadata nodeMetadata = new NodeMetadata(nodeId, randomValueOtherThanMany(
                v -> v.after(Version.CURRENT) || v.before(Version.CURRENT.minimumIndexCompatibilityVersion()), this::randomVersion))
