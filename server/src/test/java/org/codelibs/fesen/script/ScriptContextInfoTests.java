...
public class ScriptContextInfoTests extends ESTestCase {
    ...
    public void testCustomTypeContext() {
        String ct = "org.codelibs.fesen.script.ScriptContextInfoTests$CustomType";
        String ct0 = ct + 0;
        String ct1 = ct + 1;
        String ct2 = ct + 2;
    ...
    public void testTwoExecute() {
        IllegalArgumentException e =
                expectThrows(IllegalArgumentException.class, () -> new ScriptContextInfo("two_execute", TwoExecute.class));
    ...
    public void testNoExecute() {
        IllegalArgumentException e =
                expectThrows(IllegalArgumentException.class, () -> new ScriptContextInfo("no_execute", NoExecute.class));
    ...
    public void testNoParametersField() {
        IllegalArgumentException e =
                expectThrows(IllegalArgumentException.class, () -> new ScriptContextInfo("no_parameters_field", NoParametersField.class));
    ...
    public void testParameterInfoParser() throws IOException {
        ...
        XContentParser parser = XContentType.JSON.xContent().createParser(NamedXContentRegistry.EMPTY,
                DeprecationHandler.THROW_UNSUPPORTED_OPERATION, new BytesArray("{\"type\":\"foo\", \"name\": \"bar\"}").streamInput());
    ...
    public void testScriptMethodInfoParser() throws IOException {
        ...
        XContentParser parser = XContentType.JSON.xContent().createParser(NamedXContentRegistry.EMPTY,
                DeprecationHandler.THROW_UNSUPPORTED_OPERATION, new BytesArray(json).streamInput());
        ScriptContextInfo.ScriptMethodInfo info = ScriptContextInfo.ScriptMethodInfo.fromXContent(parser);
        assertEquals(new ScriptContextInfo.ScriptMethodInfo("fooFunc", "int",
                new ArrayList<>(Arrays.asList(new ScriptContextInfo.ScriptMethodInfo.ParameterInfo("int", "fooParam"),
    ...
    public void testScriptContextInfoParser() throws IOException {
        String json = "{" + "  \"name\": \"similarity\"," + "  \"methods\": [" + "    {" + "      \"name\": \"execute\","
                + "      \"return_type\": \"double\"," + "      \"params\": [" + "        {" + "          \"type\": \"double\","
                + "          \"name\": \"weight\"" + "        }," + "        {"
                + "          \"type\": \"org.codelibs.fesen.index.similarity.ScriptedSimilarity$Query\"," + "          \"name\": \"query\""
                + "        }," + "        {" + "          \"type\": \"org.codelibs.fesen.index.similarity.ScriptedSimilarity$Field\","
                + "          \"name\": \"field\"" + "        }," + "        {"
                + "          \"type\": \"org.codelibs.fesen.index.similarity.ScriptedSimilarity$Term\"," + "          \"name\": \"term\""
                + "        }," + "        {" + "          \"type\": \"org.codelibs.fesen.index.similarity.ScriptedSimilarity$Doc\","
                + "          \"name\": \"doc\"" + "        }" + "      ]" + "    }," + "    {" + "      \"name\": \"getParams\","
                + "      \"return_type\": \"java.util.Map\"," + "      \"params\": []" + "    }," + "    {" + "      \"name\": \"getDoc\","
                + "      \"return_type\": \"java.util.Map\"," + "      \"params\": []" + "    }," + "    {"
                + "      \"name\": \"get_score\"," + "      \"return_type\": \"double\"," + "      \"params\": []" + "    }" + "  ]" + "}";
        XContentParser parser = XContentType.JSON.xContent().createParser(NamedXContentRegistry.EMPTY,
                DeprecationHandler.THROW_UNSUPPORTED_OPERATION, new BytesArray(json).streamInput());
        ScriptContextInfo parsed = ScriptContextInfo.fromXContent(parser);
        ScriptContextInfo expected = new ScriptContextInfo("similarity",
                new ScriptMethodInfo("execute", "double",
                        Collections.unmodifiableList(Arrays.asList(new ParameterInfo("double", "weight"),
                                new ParameterInfo("org.codelibs.fesen.index.similarity.ScriptedSimilarity$Query", "query"),
                                new ParameterInfo("org.codelibs.fesen.index.similarity.ScriptedSimilarity$Field", "field"),
                                new ParameterInfo("org.codelibs.fesen.index.similarity.ScriptedSimilarity$Term", "term"),
                                new ParameterInfo("org.codelibs.fesen.index.similarity.ScriptedSimilarity$Doc", "doc")))),
                Collections
                        .unmodifiableSet(new HashSet<>(Arrays.asList(new ScriptMethodInfo("getParams", "java.util.Map", new ArrayList<>()),
    ...
    public void testIgnoreOtherMethodsInListConstructor() {
        ScriptContextInfo constructed = new ScriptContextInfo("otherNames",
                Collections.unmodifiableList(Arrays.asList(new ScriptMethodInfo("execute", "double", Collections.emptyList()),
                        new ScriptMethodInfo("otherName", "bool", Collections.emptyList()))));
        ScriptContextInfo expected = new ScriptContextInfo("otherNames", new ScriptMethodInfo("execute", "double", Collections.emptyList()),
    ...
    public void testNoExecuteInListConstructor() {
        IllegalArgumentException e = expectThrows(IllegalArgumentException.class,
                () -> new ScriptContextInfo("noExecute",
                        Collections.unmodifiableList(Arrays.asList(new ScriptMethodInfo("getSomeOther", "int", Collections.emptyList()),
    ...
    public void testMultipleExecuteInListConstructor() {
        IllegalArgumentException e =
                expectThrows(IllegalArgumentException.class,
                        () -> new ScriptContextInfo("multiexecute", Collections.unmodifiableList(Arrays
                                .asList(new ScriptMethodInfo("execute", "double", Collections.emptyList()), new ScriptMethodInfo("execute",
