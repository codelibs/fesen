...
public class RepositoriesModuleTests extends ESTestCase {
    ...
    public void testCanRegisterTwoRepositoriesWithDifferentTypes() {
        ...
        // Would throw
        new RepositoriesModule(environment, repoPlugins, mock(TransportService.class), mock(ClusterService.class), threadPool,
    ...
    public void testCannotRegisterTwoRepositoriesWithSameTypes() {
        ...
        IllegalArgumentException ex = expectThrows(IllegalArgumentException.class, () -> new RepositoriesModule(environment, repoPlugins,
                mock(TransportService.class), clusterService, threadPool, contentRegistry, recoverySettings));
