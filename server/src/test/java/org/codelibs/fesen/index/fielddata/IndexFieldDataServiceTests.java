...
public class IndexFieldDataServiceTests extends ESSingleNodeTestCase {
    ...
    public void testGetForFieldDefaults() {
        ...
        final MappedFieldType floatMapper =
                new NumberFieldMapper.Builder("float", NumberFieldMapper.NumberType.FLOAT, false, true).build(ctx).fieldType();
        ifdService.clear();
        ...
        final MappedFieldType doubleMapper =
                new NumberFieldMapper.Builder("double", NumberFieldMapper.NumberType.DOUBLE, false, true).build(ctx).fieldType();
        ifdService.clear();
    ...
    public void testRequireDocValuesOnLongs() {
        ...
        doTestRequireDocValues(new NumberFieldMapper.NumberFieldType("field", NumberFieldMapper.NumberType.LONG, true, false, false, false,
    ...
    public void testRequireDocValuesOnDoubles() {
        ...
        doTestRequireDocValues(new NumberFieldMapper.NumberFieldType("field", NumberFieldMapper.NumberType.DOUBLE, true, false, false,
