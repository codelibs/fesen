...
public class PreBuiltAnalyzerTests extends ESSingleNodeTestCase {
    ...
    public void testThatInstancesAreTheSameAlwaysForKeywordAnalyzer() {
        assertThat(PreBuiltAnalyzers.KEYWORD.getAnalyzer(Version.CURRENT), is(PreBuiltAnalyzers.KEYWORD.getAnalyzer(Version.V_7_0_0)));
    }
    ...
    public void testThatInstancesAreCachedAndReused() {
        ...
        assertSame(PreBuiltAnalyzers.STANDARD.getAnalyzer(Version.V_7_2_1), PreBuiltAnalyzers.STANDARD.getAnalyzer(Version.V_7_2_1));
        assertNotSame(PreBuiltAnalyzers.STANDARD.getAnalyzer(Version.V_7_0_0), PreBuiltAnalyzers.STANDARD.getAnalyzer(Version.V_7_0_1));

        // Same Lucene version should be cached:
        assertSame(PreBuiltAnalyzers.STOP.getAnalyzer(Version.V_7_2_0), PreBuiltAnalyzers.STOP.getAnalyzer(Version.V_7_2_1));
    }
    ...
    public void testThatAnalyzersAreUsedInMapping() throws IOException {
        ...
        NamedAnalyzer namedAnalyzer =
                new PreBuiltAnalyzerProvider(analyzerName, AnalyzerScope.INDEX, randomPreBuiltAnalyzer.getAnalyzer(randomVersion)).get();

        XContentBuilder mapping = XContentFactory.jsonBuilder().startObject().startObject("type").startObject("properties")
                .startObject("field").field("type", "text").field("analyzer", analyzerName).endObject().endObject().endObject().endObject();
