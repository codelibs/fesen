...
public class DynamicTemplatesTests extends MapperServiceTestCase {
    ...
    public void testSimple() throws Exception {
        String mapping = copyToStringFromClasspath("/org/codelibs/fesen/index/mapper/dynamictemplate/simple/test-mapping.json");
        MapperService mapperService = createMapperService("person", mapping);
        String docJson = copyToStringFromClasspath("/org/codelibs/fesen/index/mapper/dynamictemplate/simple/test-data.json");
