...
import org.codelibs.fesen.index.mapper.TypeParsers;
...
public class TypeParsersTests extends ESTestCase {
    ...
    public void testMultiFieldWithinMultiField() throws IOException {
        ...
        XContentBuilder mapping = XContentFactory.jsonBuilder().startObject().field("type", "keyword").startObject("fields")
                .startObject("sub-field").field("type", "keyword").startObject("fields").startObject("sub-sub-field")
                .field("type", "keyword").endObject().endObject().endObject().endObject().endObject();
        ...
        Mapper.TypeParser.ParserContext olderContext =
                new Mapper.TypeParser.ParserContext(null, mapperService, type -> typeParser, Version.CURRENT, null, null, null);
