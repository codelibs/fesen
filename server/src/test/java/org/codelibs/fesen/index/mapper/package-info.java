 ...
 * {@link org.codelibs.fesen.index.mapper.TextFieldMapper text} or
 * {@link org.codelibs.fesen.index.mapper.KeywordFieldMapper keyword} field,
 * etc. This parsing is done by the
 * {@link org.codelibs.fesen.index.mapper.DocumentParser} class which delegates
 * to various {@link org.codelibs.fesen.index.mapper.Mapper} implementations for
 * per-field handling.
