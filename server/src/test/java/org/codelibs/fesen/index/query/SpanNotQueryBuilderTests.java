...
import static org.codelibs.fesen.index.query.QueryBuilders.spanNearQuery;
import static org.codelibs.fesen.index.query.QueryBuilders.spanTermQuery;
...
public class SpanNotQueryBuilderTests extends AbstractQueryTestCase<SpanNotQueryBuilder> {
    ...
    public void testDist() {
        SpanNotQueryBuilder builder =
                new SpanNotQueryBuilder(new SpanTermQueryBuilder("name1", "value1"), new SpanTermQueryBuilder("name2", "value2"));
