...
import static org.codelibs.fesen.index.query.IntervalsSourceProvider.Disjunction;
...
public class DisjunctionIntervalsSourceProviderTests extends AbstractSerializingTestCase<Disjunction> {
    ...
    protected Disjunction mutateInstance(Disjunction instance) throws IOException {
        ...
        if (randomBoolean()) {
            ...
            filter = filter == null ? IntervalQueryBuilderTests.createRandomNonNullFilter(0, randomBoolean())
