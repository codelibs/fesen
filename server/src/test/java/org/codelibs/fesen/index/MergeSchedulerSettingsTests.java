...
import static org.codelibs.fesen.common.util.concurrent.EsExecutors.NODE_PROCESSORS_SETTING;
import static org.codelibs.fesen.index.IndexSettingsTests.newIndexMeta;
import static org.codelibs.fesen.index.MergeSchedulerConfig.MAX_MERGE_COUNT_SETTING;
import static org.codelibs.fesen.index.MergeSchedulerConfig.MAX_THREAD_COUNT_SETTING;
...
public class MergeSchedulerSettingsTests extends ESTestCase {
    ...
    public void testUpdateAutoThrottleSettings() throws Exception {
        ...
        mockAppender.start();
        final Logger settingsLogger = LogManager.getLogger("org.codelibs.fesen.common.settings.IndexScopedSettings");
