...
public class JavaMultiFieldMergeTests extends ESSingleNodeTestCase {
    public void testMergeMultiField() throws Exception {
        String mapping = copyToStringFromClasspath("/org/codelibs/fesen/index/mapper/multifield/merge/test-mapping1.json");
        ...
        mapping = copyToStringFromClasspath("/org/codelibs/fesen/index/mapper/multifield/merge/test-mapping2.json");
        mapperService.merge("person", new CompressedXContent(mapping), MapperService.MergeReason.MAPPING_UPDATE);
        ...
        mapping = copyToStringFromClasspath("/org/codelibs/fesen/index/mapper/multifield/merge/test-mapping3.json");
        mapperService.merge("person", new CompressedXContent(mapping), MapperService.MergeReason.MAPPING_UPDATE);
        ...
        mapping = copyToStringFromClasspath("/org/codelibs/fesen/index/mapper/multifield/merge/test-mapping4.json");
        mapperService.merge("person", new CompressedXContent(mapping), MapperService.MergeReason.MAPPING_UPDATE);
    ...
    public void testUpgradeFromMultiFieldTypeToMultiFields() throws Exception {
        ...
        mapping = copyToStringFromClasspath("/org/codelibs/fesen/index/mapper/multifield/merge/upgrade1.json");
        mapperService.merge("person", new CompressedXContent(mapping), MapperService.MergeReason.MAPPING_UPDATE);
        ...
        mapping = copyToStringFromClasspath("/org/codelibs/fesen/index/mapper/multifield/merge/upgrade2.json");
        mapperService.merge("person", new CompressedXContent(mapping), MapperService.MergeReason.MAPPING_UPDATE);
        ...
        mapping = copyToStringFromClasspath("/org/codelibs/fesen/index/mapper/multifield/merge/upgrade3.json");
        try {
            mapperService.merge("person", new CompressedXContent(mapping), MapperService.MergeReason.MAPPING_UPDATE);
            fail();
