...
public class ParametrizedMapperTests extends MapperServiceTestCase {
    ...
    public static class Builder extends ParametrizedFieldMapper.Builder {
        ...
        final Parameter<Boolean> fixed2 =
                Parameter.boolParam("fixed2", false, m -> toType(m).fixed2, false).addDeprecatedName("fixed2_old");
    ...
    private static TestMapper fromMapping(String mapping, Version version) {
        ...
        IndexAnalyzers indexAnalyzers = new IndexAnalyzers(
                org.codelibs.fesen.core.Map.of("_standard", Lucene.STANDARD_ANALYZER, "_keyword", Lucene.KEYWORD_ANALYZER, "default",
    ...
    public void testDefaults() throws IOException {
        ...
        assertEquals("{\"field\":{\"type\":\"test_mapper\",\"fixed\":true," + "\"fixed2\":false,\"variable\":\"default\",\"index\":true,"
                + "\"wrapper\":\"default\",\"int_value\":5,\"analyzer\":\"_keyword\"," + "\"required\":\"value\",\"restricted\":\"foo\"}}",
    ...
    public void testObjectSerialization() throws IOException {
        ...
        String mapping = "{\"_doc\":{" + "\"properties\":{" + "\"actual\":{\"type\":\"double\"}," + "\"bucket_count\":{\"type\":\"long\"},"
                + "\"bucket_influencers\":{\"type\":\"nested\",\"properties\":{" + "\"anomaly_score\":{\"type\":\"double\"},"
                + "\"bucket_span\":{\"type\":\"long\"}," + "\"is_interim\":{\"type\":\"boolean\"}}}}}}";
    ...
    public void testLinkedAnalyzers() throws IOException {
        ...
        assertEquals("{\"field\":{\"type\":\"test_mapper\",\"fixed\":true," + "\"fixed2\":false,\"variable\":\"default\",\"index\":true,"
                + "\"wrapper\":\"default\",\"int_value\":5,\"analyzer\":\"default\"," + "\"required\":\"value\",\"restricted\":\"foo\"}}",
                toStringWithDefaults(mapper));
    }
