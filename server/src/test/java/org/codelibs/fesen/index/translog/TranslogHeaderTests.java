...
public class TranslogHeaderTests extends ESTestCase {
    ...
    public void testLegacyTranslogVersions() throws Exception {
        ...
        checkFailsToOpen("/org/codelibs/fesen/index/translog/translog-v1-truncated.binary", IllegalStateException.class, "pre-2.0 translog");
        checkFailsToOpen("/org/codelibs/fesen/index/translog/translog-v1-corrupted-magic.binary",
            TranslogCorruptedException.class, "translog looks like version 1 or later, but has corrupted header");
        checkFailsToOpen("/org/codelibs/fesen/index/translog/translog-v1-corrupted-body.binary",
