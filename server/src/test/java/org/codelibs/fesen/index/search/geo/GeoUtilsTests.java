...
package org.codelibs.fesen.index.search.geo;
...
public class GeoUtilsTests extends ESTestCase {
    ...
    public void testParseGeoPointStringZValueError() throws IOException {
        ...
        try (XContentParser parser = createParser(json)) {
            ...
            Exception e = expectThrows(FesenParseException.class, () -> GeoUtils.parseGeoPoint(parser, new GeoPoint(), false));
    ...
    public void testParseGeoPointGeohashWrongType() throws IOException {
        ...
        try (XContentParser parser = createParser(json)) {
            parser.nextToken();
            Exception e = expectThrows(FesenParseException.class, () -> GeoUtils.parseGeoPoint(parser));
