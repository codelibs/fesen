...
import org.codelibs.fesen.transport.TransportRequest.Empty;
...
public class SearchOperationListenerTests extends ESTestCase {
    ...
    public void testListenersAreExecuted() {
        ...
        SearchOperationListener throwingListener =
                (SearchOperationListener) Proxy.newProxyInstance(SearchOperationListener.class.getClassLoader(),
                        new Class[] { SearchOperationListener.class }, (a, b, c) -> {
