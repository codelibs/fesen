...
import org.codelibs.fesen.common.lucene.search.MoreLikeThisQuery;
...
import org.codelibs.fesen.index.query.MoreLikeThisQueryBuilder.Item;
...
import static org.codelibs.fesen.index.query.QueryBuilders.moreLikeThisQuery;
...
public class MoreLikeThisQueryBuilderTests extends AbstractQueryTestCase<MoreLikeThisQueryBuilder> {
    ...
    private XContentBuilder randomArtificialDoc() {
        ...
        try {
            ...
            throw new FesenException("Unable to generate random artificial doc!");
        }
        return doc;
    }
    ...
    public void testMoreLikeThisBuilder() throws Exception {
        Query parsedQuery = parseQuery(moreLikeThisQuery(new String[] { "name.first", "name.last" }, new String[] { "something" }, null)
