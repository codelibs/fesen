...
import static org.codelibs.fesen.index.query.QueryBuilders.commonTermsQuery;
...
public class CommonTermsQueryBuilderTests extends AbstractQueryTestCase<CommonTermsQueryBuilder> {
    ...
    protected Map<String, CommonTermsQueryBuilder> getAlternateVersions() {
        ...
        CommonTermsQueryBuilder commonTermsQuery =
                new CommonTermsQueryBuilder(randomAlphaOfLengthBetween(1, 10), randomAlphaOfLengthBetween(1, 10));
    ...
    public void testCommonTermsQuery1() throws IOException {
        String query = copyToStringFromClasspath("/org/codelibs/fesen/index/query/commonTerms-query1.json");
    ...
    public void testCommonTermsQuery2() throws IOException {
        String query = copyToStringFromClasspath("/org/codelibs/fesen/index/query/commonTerms-query2.json");
        Query parsedQuery = parseQuery(query).toQuery(createShardContext());
        assertThat(parsedQuery, instanceOf(ExtendedCommonTermsQuery.class));
        ExtendedCommonTermsQuery ectQuery = (ExtendedCommonTermsQuery) parsedQuery;
    ...
    public void testCommonTermsQuery3() throws IOException {
        String query = copyToStringFromClasspath("/org/codelibs/fesen/index/query/commonTerms-query3.json");
        Query parsedQuery = parseQuery(query).toQuery(createShardContext());
        assertThat(parsedQuery, instanceOf(ExtendedCommonTermsQuery.class));
        ExtendedCommonTermsQuery ectQuery = (ExtendedCommonTermsQuery) parsedQuery;
        assertThat(ectQuery.getHighFreqMinimumNumberShouldMatchSpec(), nullValue());
