...
import org.codelibs.fesen.index.shard.EngineAccess;
...
public class InternalEngineSettingsTests extends ESSingleNodeTestCase {
    ...
    public void testSettingsUpdate() {
        ...
        for (int i = 0; i < iters; i++) {
            ...
            Settings build =
                    Settings.builder().put(IndexSettings.INDEX_GC_DELETES_SETTING.getKey(), gcDeletes, TimeUnit.MILLISECONDS).build();
