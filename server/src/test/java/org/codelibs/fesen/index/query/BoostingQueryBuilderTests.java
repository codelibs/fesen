...
public class BoostingQueryBuilderTests extends AbstractQueryTestCase<BoostingQueryBuilder> {
    ...
    public void testRewriteToMatchNone() throws IOException {
        BoostingQueryBuilder builder = new BoostingQueryBuilder(new TermQueryBuilder("unmapped_field", "value"),
    ...
    public void testMustRewrite() throws IOException {
        ...
        BoostingQueryBuilder queryBuilder1 =
                new BoostingQueryBuilder(new TermQueryBuilder("unmapped_field", "foo"), new MatchNoneQueryBuilder());
        IllegalStateException e = expectThrows(IllegalStateException.class, () -> queryBuilder1.toQuery(context));
        assertEquals("Rewrite first", e.getMessage());

        BoostingQueryBuilder queryBuilder2 =
                new BoostingQueryBuilder(new MatchAllQueryBuilder(), new TermQueryBuilder("unmapped_field", "foo"));
