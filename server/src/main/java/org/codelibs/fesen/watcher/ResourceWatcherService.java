 ...
 *
 * Other fesen services can register their resource watchers with this service using {@link #add(ResourceWatcher)}
 * method. This service will call {@link org.codelibs.fesen.watcher.ResourceWatcher#checkAndNotify()} method of all
