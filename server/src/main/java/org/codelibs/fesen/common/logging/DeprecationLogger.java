 ...
 * for deprecation logger. For instance <code>DeprecationLogger.getLogger("org.codelibs.fesen.test.SomeClass")</code> will
 * result in a deprecation logger with name <code>org.codelibs.fesen.deprecation.test.SomeClass</code>. This allows to use a
...
public class DeprecationLogger {
     ...
     * prefixes the logger name with "deprecation", if it starts with "org.codelibs.fesen.",
     * it replaces "org.codelibs.fesen" with "org.codelibs.fesen.deprecation" to maintain
     * the "org.codelibs.fesen" namespace.
     */
    ...
    private static Logger getDeprecatedLoggerForName(String name) {
        if (name.startsWith("org.codelibs.fesen")) {
            name = name.replace("org.codelibs.fesen.", "org.codelibs.fesen.deprecation.");
        } else {
