...
import org.codelibs.fesen.common.inject.Exposed;
...
public class ProviderMethod<T> implements ProviderWithDependencies<T> {
     ...
     */
    ProviderMethod(Key<T> key, Method method, Object instance, Set<Dependency<?>> dependencies, List<Provider<?>> parameterProviders,
