...
public class BytesStreamOutput extends BytesStream {
    ...
    /**
     * Returns the number of bytes used by the underlying {@link org.codelibs.fesen.common.util.ByteArray}
     * @see org.codelibs.fesen.common.util.ByteArray#ramBytesUsed()
     */
