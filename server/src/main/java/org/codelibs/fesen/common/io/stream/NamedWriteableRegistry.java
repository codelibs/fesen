...
/**
 * A registry for {@link org.codelibs.fesen.common.io.stream.Writeable.Reader} readers of {@link NamedWriteable}.
 *
        ...
        for (Entry entry : entries) {
            ...
            if (oldReader != null) {
                throw new IllegalArgumentException(
                        "NamedWriteable [" + currentCategory.getName() + "][" + entry.name + "]" + " is already registered for ["
                                + oldReader.getClass().getName() + "]," + " cannot register [" + entry.reader.getClass().getName() + "]");
            }
        }
