...
public class LoggingDeprecationHandler implements DeprecationHandler {
    ...
    public void usedDeprecatedName(String parserName, Supplier<XContentLocation> location, String usedName, String modernName) {
        ...
        deprecationLogger.deprecate("deprecated_field", "{}Deprecated field [{}] used, expected [{}] instead", prefix, usedName,
                modernName);
    }
    ...
    public void usedDeprecatedField(String parserName, Supplier<XContentLocation> location, String usedName) {
        String prefix = parserName == null ? "" : "[" + parserName + "][" + location.get() + "] ";
        deprecationLogger.deprecate("deprecated_field", "{}Deprecated field [{}] used, this field is unused and will be removed entirely",
                prefix, usedName);
    }
}
