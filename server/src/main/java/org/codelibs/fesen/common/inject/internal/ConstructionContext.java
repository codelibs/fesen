...
public class ConstructionContext<T> {
    ...
    public Object createProxy(Errors errors, Class<?> expectedType) throws ErrorsException {
        ...
        ClassLoader classLoader =
                expectedType.getClassLoader() == null ? ClassLoader.getSystemClassLoader() : expectedType.getClassLoader();
        ...
        public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
            if (delegate == null) {
                throw new IllegalStateException("This is a proxy used to support"
                        ...
                        + " proxying is not constructed yet. Please wait until after" + " injection has completed to use this object.");
            }
