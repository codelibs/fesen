...
import org.codelibs.fesen.common.inject.internal.ConstructionContext;
...
class ConstructorInjector<T> {
    ...
    ConstructorInjector(Set<InjectionPoint> injectableMembers, ConstructionProxy<T> constructionProxy,
            SingleParameterInjector<?>[] parameterInjectors, MembersInjectorImpl<T> membersInjector) throws ErrorsException {
