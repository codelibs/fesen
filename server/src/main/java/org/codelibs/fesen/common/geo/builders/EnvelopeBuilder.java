...
public class EnvelopeBuilder extends ShapeBuilder<Rectangle, org.codelibs.fesen.geometry.Rectangle, EnvelopeBuilder> {
    ...
    @Override
    public org.codelibs.fesen.geometry.Rectangle buildGeometry() {
        return new org.codelibs.fesen.geometry.Rectangle(topLeft.x, bottomRight.x, topLeft.y, bottomRight.y);
    }
