 ...
 * reproducible tests. When running the Fesen test suite, the
 ...
 * when running under the Fesen test suite. Alternatively,
 * a reproducible source of randomness can be produced by providing a
 * setting a reproducible seed. When running the Fesen server
...
public final class Randomness {
     ...
     * running under the Fesen test suite, and otherwise
