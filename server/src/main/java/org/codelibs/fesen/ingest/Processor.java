...
public interface Processor {
     ...
     * and that gets passed around to all {@link org.codelibs.fesen.plugins.IngestPlugin}s.
     */
    class Parameters {
        ...
        /**
         * Allows processors to read headers set by {@link org.codelibs.fesen.action.support.ActionFilter}
