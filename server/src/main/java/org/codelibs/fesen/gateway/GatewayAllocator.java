...
public class GatewayAllocator implements ExistingShardsAllocator {
    ...
    @Inject
    public GatewayAllocator(RerouteService rerouteService, TransportNodesListGatewayStartedShards startedAction,
    ...
    protected static void innerAllocatedUnassigned(RoutingAllocation allocation, PrimaryShardAllocator primaryShardAllocator,
            ReplicaShardAllocator replicaShardAllocator, ShardRouting shardRouting,
    ...
    private void ensureAsyncFetchStorePrimaryRecency(RoutingAllocation allocation) {
        ...
        if (hasNewNodes(nodes)) {
            ...
            logger.trace(() -> new ParameterizedMessage("new nodes {} found, clearing primary async-fetch-store cache",
    ...
    class InternalAsyncFetch<T extends BaseNodeResponse> extends AsyncShardFetch<T> {
        ...
        protected void reroute(ShardId shardId, String reason) {
            ...
            rerouteService.reroute("async_shard_fetch", Priority.HIGH,
                    ActionListener.wrap(r -> logger.trace("{} scheduled reroute completed for {}", shardId, reason),
