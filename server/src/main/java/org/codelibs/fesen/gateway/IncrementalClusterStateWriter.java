...
public class IncrementalClusterStateWriter {
    ...
    private Map<Index, Long> writeIndicesMetadata(AtomicClusterStateWriter writer, ClusterState newState) throws WriteStateException {
        ...
        Iterable<IndexMetadataAction> actions =
                resolveIndexMetadataActions(previouslyWrittenIndices, relevantIndices, previousMetadata, newState.metadata());
     ...
     */
    // exposed for tests
    static List<IndexMetadataAction> resolveIndexMetadataActions(Map<Index, Long> previouslyWrittenIndices, Set<Index> relevantIndices,
