...
public interface RecoveryTargetHandler {
     ...
     *                                            {@link org.codelibs.fesen.index.mapper.MapperException}; otherwise we should wait for a
     ...
     */
    void receiveFileInfo(List<String> phase1FileNames, List<Long> phase1FileSizes, List<String> phase1ExistingFileNames,
