 ...
 * {@link org.codelibs.fesen.repositories.blobstore.BlobStoreRepository#finalizeSnapshot} the identifier for an instance of
...
public final class IndexMetaDataGenerations {
    ...
    /**
     * Gets the blob id by the identifier of {@link org.codelibs.fesen.cluster.metadata.IndexMetadata}
     ...
     * {@link org.codelibs.fesen.snapshots.SnapshotsService#SHARD_GEN_IN_REPO_DATA_VERSION} which used the snapshot uuid as index metadata
     * blob uuid.
     *
