...
public final class ShardGenerations {
     ...
     * {@link org.codelibs.fesen.index.snapshots.blobstore.BlobStoreIndexShardSnapshots} blob for it.
     */
    ...
    public Map<IndexId, Map<Integer, String>> obsoleteShardGenerations(ShardGenerations previous) {
        ...
        previous.shardGenerations.forEach(((indexId, oldGens) -> {
            ...
            assert updatedGenerations != null : "Index [" + indexId
    ...
    /**
     * Get the generation of the {@link org.codelibs.fesen.index.snapshots.blobstore.BlobStoreIndexShardSnapshots} blob for a given index
     * and shard.
     ...
     *     {@link org.codelibs.fesen.snapshots.SnapshotsService#SHARD_GEN_IN_REPO_DATA_VERSION}. If a caller expects a shard to exist in the
     ...
     * @return generation of the {@link org.codelibs.fesen.index.snapshots.blobstore.BlobStoreIndexShardSnapshots} blob
     */
    @Nullable
