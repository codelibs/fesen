...
public interface Repository extends LifecycleComponent {
     ...
     * See {@link org.codelibs.fesen.plugins.RepositoryPlugin}.
     */
    interface Factory {
        /**
     ...
     *             {@link org.codelibs.fesen.snapshots.SnapshotsService#NO_REPO_INITIALIZE_VERSION} is present.
     */
    @Deprecated
     ...
     * @param verificationToken value returned by {@link org.codelibs.fesen.repositories.Repository#startVerification()}
     ...
     * <p>
     * The index commit point can be obtained by using {@link org.codelibs.fesen.index.engine.Engine#acquireLastIndexCommit} method.
     ...
     * thus the same semantics as with {@link org.codelibs.fesen.cluster.ClusterStateApplier#applyClusterState} apply for the
