...
import org.codelibs.fesen.index.similarity.ScriptedSimilarity;
...
public abstract class SimilarityScript {
     ...
     */
    public abstract double execute(double weight, ScriptedSimilarity.Query query, ScriptedSimilarity.Field field,
