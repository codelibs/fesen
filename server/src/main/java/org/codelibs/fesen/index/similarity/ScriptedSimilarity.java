...
public final class ScriptedSimilarity extends Similarity {
    ...
    /** Sole constructor. */
    public ScriptedSimilarity(String weightScriptString, SimilarityWeightScript.Factory weightScriptFactory, String scriptString,
            SimilarityScript.Factory scriptFactory, boolean discountOverlaps) {
        ...
        for (int i = 0; i < terms.length; ++i) {
            ...
            scorers[i] = new SimScorer() {
                ...
                public Explanation explain(Explanation freq, long norm) {
                    ...
                    return Explanation.match(score, "score from " + ScriptedSimilarity.this.toString() + " computed from:",
                            Explanation.match((float) scoreWeight, "weight"), Explanation.match(query.boost, "query.boost"),
                            Explanation.match(field.docCount, "field.docCount"), Explanation.match(field.sumDocFreq, "field.sumDocFreq"),
                            Explanation.match(field.sumTotalTermFreq, "field.sumTotalTermFreq"),
                            Explanation.match(term.docFreq, "term.docFreq"), Explanation.match(term.totalTermFreq, "term.totalTermFreq"),
