...
public final class EngineConfig {
     ...
     * {@link org.codelibs.fesen.threadpool.ThreadPool#relativeTimeInMillis()} and to schedule
     * async force merge calls on the {@link org.codelibs.fesen.threadpool.ThreadPool.Names#FORCE_MERGE} thread-pool
     */
    ...
    /**
     * Returns an {@link org.codelibs.fesen.index.engine.Engine.Warmer} used to warm new searchers before they are used for searching.
     */
    ...
    /**
     * Returns the {@link org.codelibs.fesen.index.store.Store} instance that provides access to the
