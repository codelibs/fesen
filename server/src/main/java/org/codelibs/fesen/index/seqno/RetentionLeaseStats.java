...
public final class RetentionLeaseStats implements ToXContentFragment, Writeable {
    ...
    /**
     * Converts the retention lease stats to {@link org.codelibs.fesen.common.xcontent.XContent} using the specified builder and pararms.
     *
     * @param builder the builder
     * @param params  the params
     * @return the builder that this retention lease collection was converted to {@link org.codelibs.fesen.common.xcontent.XContent} into
