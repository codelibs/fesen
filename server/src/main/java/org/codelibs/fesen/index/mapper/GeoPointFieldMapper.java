...
import org.codelibs.fesen.index.fielddata.plain.AbstractLatLonPointIndexFieldData;
import org.codelibs.fesen.index.mapper.GeoPointFieldMapper.ParsedGeoPoint;
    ...
    protected static class ParsedGeoPoint extends GeoPoint implements AbstractPointGeometryFieldMapper.ParsedPoint {
        ...
        public void normalize(String name) {
            if (isNormalizable(lat()) && isNormalizable(lon())) {
                ...
                throw new FesenParseException("cannot normalize the point - not a number");
            }
        }
