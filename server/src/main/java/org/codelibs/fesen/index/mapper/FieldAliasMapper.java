...
public final class FieldAliasMapper extends Mapper {
    ...
    public void validate(MappingLookup mappers) {
        ...
        if (mappers.fieldTypes().get(path) == null) {
            throw new MapperParsingException("Invalid [path] value [" + path + "] for field alias [" + name()
        ...
        if (!Objects.equals(aliasScope, pathScope)) {
            StringBuilder message = new StringBuilder("Invalid [path] value [" + path + "] for field alias [" + name
