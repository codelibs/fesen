...
public final class RetentionLease implements ToXContentObject, Writeable {
    ...
    /**
     * Parses a retention lease from {@link org.codelibs.fesen.common.xcontent.XContent}. This method assumes that the retention lease was
     * converted to {@link org.codelibs.fesen.common.xcontent.XContent} via {@link #toXContent(XContentBuilder, Params)}.
     *
