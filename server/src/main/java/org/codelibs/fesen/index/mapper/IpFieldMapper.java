...
public class IpFieldMapper extends ParametrizedFieldMapper {
    ...
    public static class Builder extends ParametrizedFieldMapper.Builder {
        ...
        public IpFieldMapper build(BuilderContext context) {
            return new IpFieldMapper(name, new IpFieldType(buildFullName(context), indexed.getValue(), stored.getValue(),
                    hasDocValues.getValue(), parseNullValue(), meta.getValue()), multiFieldsBuilder.build(this, context), copyTo.build(),
                    this);
        }
    ...
    public static final class IpFieldType extends SimpleMappedFieldType {
        ...
        public IpFieldType(String name, boolean indexed, boolean stored, boolean hasDocValues, InetAddress nullValue,
         ...
         */
        public static Query rangeQuery(Object lowerTerm, Object upperTerm, boolean includeLower, boolean includeUpper,
        ...
        public static final class IpScriptDocValues extends ScriptDocValues<String> {
            ...
            public String get(int index) {
                try {
                    ...
                    InetAddress address =
                            InetAddressPoint.decode(Arrays.copyOfRange(encoded.bytes, encoded.offset, encoded.offset + encoded.length));
                    return InetAddresses.toAddrString(address);
                } catch (IOException e) {
