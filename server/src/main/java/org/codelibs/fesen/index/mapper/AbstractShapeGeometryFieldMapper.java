...
import org.codelibs.fesen.index.mapper.LegacyGeoShapeFieldMapper.DeprecatedParameters;
...
public abstract class AbstractShapeGeometryFieldMapper<Parsed, Processed> extends AbstractGeometryFieldMapper<Parsed, Processed> {
    ...
    public abstract static class Builder<T extends Builder<T, FT>, FT extends AbstractShapeGeometryFieldType>
        ...
        public Builder(String name, FieldType fieldType, boolean coerce, boolean ignoreMalformed, Orientation orientation,
                boolean ignoreZ) {
    ...
    protected AbstractShapeGeometryFieldMapper(String simpleName, FieldType fieldType, MappedFieldType mappedFieldType,
            Explicit<Boolean> ignoreMalformed, Explicit<Boolean> coerce, Explicit<Boolean> ignoreZValue, Explicit<Orientation> orientation,
