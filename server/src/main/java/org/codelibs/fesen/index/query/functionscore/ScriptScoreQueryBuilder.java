...
public class ScriptScoreQueryBuilder extends AbstractQueryBuilder<ScriptScoreQueryBuilder> {
    ...
    private static final ConstructingObjectParser<ScriptScoreQueryBuilder, Void> PARSER =
    ...
    protected boolean doEquals(ScriptScoreQueryBuilder other) {
        return Objects.equals(this.query, other.query) && Objects.equals(this.script, other.script)
    ...
    protected Query doToQuery(QueryShardContext context) throws IOException {
        ...
        return new ScriptScoreQuery(query, script, scoreScriptFactory, minScore, context.index().getName(), context.getShardId(),
