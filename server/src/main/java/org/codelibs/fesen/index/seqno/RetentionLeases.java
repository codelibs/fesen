...
public class RetentionLeases implements ToXContentFragment, Writeable {
    ...
    /**
     * Parses a retention leases collection from {@link org.codelibs.fesen.common.xcontent.XContent}. This method assumes that the retention
     * leases were converted to {@link org.codelibs.fesen.common.xcontent.XContent} via {@link #toXContent(XContentBuilder, Params)}.
     *
