...
public class NamedAnalyzer extends DelegatingAnalyzerWrapper {
    ...
    public NamedAnalyzer(String name, AnalyzerScope scope, Analyzer analyzer, int positionIncrementGap) {
        ...
        if (analyzer instanceof org.codelibs.fesen.index.analysis.AnalyzerComponentsProvider) {
            this.analysisMode = ((org.codelibs.fesen.index.analysis.AnalyzerComponentsProvider) analyzer).getComponents().analysisMode();
        } else {
