...
public interface ClusterAdminClient extends ElasticsearchClient {
     ...
     * @return The result future
     * @see org.codelibs.fesen.client.Requests#nodesInfoRequest(String...)
     */
     ...
     * @return The result future
     * @see org.codelibs.fesen.client.Requests#clusterStatsRequest
     */
     ...
     * @return The result future
     * @see org.codelibs.fesen.client.Requests#nodesStatsRequest(String...)
     */
     ...
     * @return The result future
     * @see org.codelibs.fesen.client.Requests#nodesUsageRequest(String...)
     */
     ...
     * @return The result future
     * @see org.codelibs.fesen.client.Requests#listTasksRequest()
     */
     ...
     * @return the result future
     * @see org.codelibs.fesen.client.Requests#getTaskRequest()
     */
     ...
     * @param request The nodes tasks request
     * @return The result future
     * @see org.codelibs.fesen.client.Requests#cancelTasksRequest()
     */
