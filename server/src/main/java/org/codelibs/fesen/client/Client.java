 ...
 * simply returns an {@link org.codelibs.fesen.action.ActionFuture}, while the second accepts an
 * {@link org.codelibs.fesen.action.ActionListener}.
 * <p>
 * A client can either be retrieved from a {@link org.codelibs.fesen.node.Node} started, or connected remotely
 * to one or more nodes using {@link org.codelibs.fesen.client.transport.TransportClient}.
 *
...
public interface Client extends FesenClient, Releasable {
     ...
     * @return The result future
     * @see org.codelibs.fesen.client.Requests#bulkRequest()
     */
