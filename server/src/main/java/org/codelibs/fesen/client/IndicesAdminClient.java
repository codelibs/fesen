...
public interface IndicesAdminClient extends FesenClient {
     ...
     * @return The result future
     * @see org.codelibs.fesen.client.Requests#createIndexRequest(String)
     */
     ...
     * @return The result future
     * @see org.codelibs.fesen.client.Requests#deleteIndexRequest(String)
     */
     ...
     * @return The result future
     * @see org.codelibs.fesen.client.Requests#closeIndexRequest(String)
     */
     ...
     * @param request The close index request
     * @return The result future
     * @see org.codelibs.fesen.client.Requests#openIndexRequest(String)
     */
     ...
     * @return The result future
     * @see org.codelibs.fesen.client.Requests#refreshRequest(String...)
     */
     ...
     * @return A result future
     * @see org.codelibs.fesen.client.Requests#upgradeRequest(String...)
     */
     ...
     * @return A result future
     * @see org.codelibs.fesen.client.Requests#putMappingRequest(String...)
     */
     ...
     * @see #getSettings(org.codelibs.fesen.action.admin.indices.settings.get.GetSettingsRequest)
     */
