...
interface SearchPhaseContext extends Executor {
    ...
    /**
     * Returns a connection to the node if connected otherwise and {@link org.codelibs.fesen.transport.ConnectTransportException} will be
     * thrown.
     */
     ...
     * @see org.codelibs.fesen.search.query.QuerySearchResult#getContextId()
