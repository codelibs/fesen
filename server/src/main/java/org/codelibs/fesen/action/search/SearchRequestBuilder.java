...
public class SearchRequestBuilder extends ActionRequestBuilder<SearchRequest, SearchResponse> {
    ...
    /**
     * The search type to execute, defaults to {@link org.codelibs.fesen.action.search.SearchType#DEFAULT}.
     */
    ...
    /**
     * Should each {@link org.codelibs.fesen.search.SearchHit} be returned with an
    ...
    /**
     * Should each {@link org.codelibs.fesen.search.SearchHit} be returned with its
     * version.
     */
     ...
     *
     * @see org.codelibs.fesen.search.sort.SortBuilders
     */
     ...
     * {@link #addRescorer(org.codelibs.fesen.search.rescore.RescorerBuilder, int)}.
     *
