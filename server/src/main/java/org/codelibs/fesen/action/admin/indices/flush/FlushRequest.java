 ...
 * by flushing data to the index storage and clearing the internal transaction log. By default, Fesen uses
 * memory heuristics in order to automatically trigger flush operations as required in order to clear memory.
 * <p>
 * Best created with {@link org.codelibs.fesen.client.Requests#flushRequest(String...)}.
 *
 * @see org.codelibs.fesen.client.Requests#flushRequest(String...)
 * @see org.codelibs.fesen.client.IndicesAdminClient#flush(FlushRequest)
 * @see FlushResponse
 */
