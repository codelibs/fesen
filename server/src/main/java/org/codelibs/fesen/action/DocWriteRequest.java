 ...
 * Action requests implementing this can be part of {@link org.codelibs.fesen.action.bulk.BulkRequest}
 */
public interface DocWriteRequest<T> extends IndicesRequest, Accountable {
     ...
     *
     * @param shardId shard id of the request. {@code null} when reading as part of a {@link org.codelibs.fesen.action.bulk.BulkRequest}
     *                that does not have a unique shard id or when reading from a stream of version older than
     *                {@link org.codelibs.fesen.action.bulk.BulkShardRequest#COMPACT_SHARD_ID_VERSION}
     */
