...
public class BulkItemResponse implements Writeable, StatusToXContentObject {
    ...
    public XContentBuilder toXContent(XContentBuilder builder, Params params) throws IOException {
        ...
        if (failure == null) {
            ...
            FesenException.generateThrowableXContent(builder, params, failure.getCause());
            builder.endObject();
        }
        builder.endObject();
        builder.endObject();
    ...
    public static class Failure implements Writeable, ToXContentFragment {
        ...
        static {
            ...
            PARSER.declareObject(constructorArg(), (p, c) -> FesenException.fromXContent(p), new ParseField(CAUSE_FIELD));
