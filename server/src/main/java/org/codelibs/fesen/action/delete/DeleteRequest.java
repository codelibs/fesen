 ...
 * {@link org.codelibs.fesen.client.Requests#deleteRequest(String)}.
 * <p>
 * The operation requires the {@link #index()}, {@link #type(String)} and {@link #id(String)} to
 * be set.
 *
 * @see DeleteResponse
 * @see org.codelibs.fesen.client.Client#delete(DeleteRequest)
 * @see org.codelibs.fesen.client.Requests#deleteRequest(String)
 */
