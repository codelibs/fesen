...
public class ClusterStateRequestBuilder extends MasterNodeReadOperationRequestBuilder<ClusterStateRequest,
    ...
    /**
     * Should the cluster state result include the {@link org.codelibs.fesen.cluster.metadata.Metadata}. Defaults
     * to {@code true}.
     */
    ...
    /**
     * Should the cluster state result include the {@link org.codelibs.fesen.cluster.node.DiscoveryNodes}. Defaults
     * to {@code true}.
     */
    ...
    /**
     * Should the cluster state result include the {@link org.codelibs.fesen.cluster.ClusterState.Custom}. Defaults
     * to {@code true}.
     */
    ...
    /**
     * Should the cluster state result include the {@link org.codelibs.fesen.cluster.routing.RoutingTable}. Defaults
     * to {@code true}.
     */
    ...
    /**
     * When {@link #setMetadata(boolean)} is set, which indices to return the {@link org.codelibs.fesen.cluster.metadata.IndexMetadata}
