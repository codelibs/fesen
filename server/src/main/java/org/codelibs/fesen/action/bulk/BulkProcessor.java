...
public class BulkProcessor implements Closeable {
    ...
    public static class Builder {
         ...
         * <p>
         * Note, both {@link #setBulkActions(int)} and {@link #setBulkSize(org.codelibs.fesen.common.unit.ByteSizeValue)}
         ...
         *
         * @see org.codelibs.fesen.action.bulk.BackoffPolicy#exponentialBackoff()
         */
     ...
     * @param listener The BulkProcessor listener that gets called on bulk events
     * @return the builder for BulkProcessor
     * @deprecated Use {@link #builder(java.util.function.BiConsumer, org.codelibs.fesen.action.bulk.BulkProcessor.Listener)}
     * with client::bulk as the first argument, or {@link #builder(org.codelibs.fesen.client.Client,
     * org.codelibs.fesen.action.bulk.BulkProcessor.Listener, org.codelibs.fesen.threadpool.Scheduler,
     * org.codelibs.fesen.threadpool.Scheduler, java.lang.Runnable)} and manage the flush and retry schedulers explicitly
     */
    @Deprecated
