 ...
 * {@link org.codelibs.fesen.client.Requests#getRequest(String)}.
 * <p>
 * The operation requires the {@link #index()}, {@link #type(String)} and {@link #id(String)}
 * to be set.
 *
 * @see org.codelibs.fesen.action.get.GetResponse
 * @see org.codelibs.fesen.client.Requests#getRequest(String)
 * @see org.codelibs.fesen.client.Client#get(GetRequest)
 */
public class GetRequest extends SingleShardRequest<GetRequest> implements RealtimeRequest {
    ...
    /**
     * Sets the versioning type. Defaults to {@link org.codelibs.fesen.index.VersionType#INTERNAL}.
     */
