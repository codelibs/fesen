...
public class IndexRequestBuilder extends ReplicationRequestBuilder<IndexRequest, IndexResponse, IndexRequestBuilder>
     ...
     * <p>
     * Note, its preferable to either set it using {@link #setSource(org.codelibs.fesen.common.xcontent.XContentBuilder)}
    ...
    /**
     * Set to {@code true} to force this index to use {@link org.codelibs.fesen.action.index.IndexRequest.OpType#CREATE}.
     */
