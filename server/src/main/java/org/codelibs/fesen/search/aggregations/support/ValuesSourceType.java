...
public interface ValuesSourceType {
     ...
     * {@link org.codelibs.fesen.search.aggregations.AggregationExecutionException}.  Note that this method is called when a script is
     ...
     * {@link org.codelibs.fesen.search.aggregations.AggregationExecutionException}
     *
     ...
     * {@link org.codelibs.fesen.index.mapper.MappedFieldType}, it prefers to get the formatter from there.  Only when a field can't be
