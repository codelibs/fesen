...
public class ContextMappings implements ToXContent, Iterable<ContextMapping<?>> {
     ...
     * see {@link org.codelibs.fesen.search.suggest.completion.context.ContextMappings.TypedContextField}
     */
     ...
     *
     */
    public static ContextMappings load(Object configuration, Version indexVersionCreated) throws FesenParseException {
        ...
        if (configuration instanceof List) {
            ...
            if (contextMappings.size() == 0) {
                throw new FesenParseException("expected at least one context mapping");
            }
            ...
            throw new FesenParseException("expected a list or an entry of context mapping");
        }
    ...
    private static String extractRequiredValue(Map<String, Object> contextConfig, String paramName) {
        ...
        if (paramValue == null) {
            throw new FesenParseException("missing [" + paramName + "] in context mapping");
        }
