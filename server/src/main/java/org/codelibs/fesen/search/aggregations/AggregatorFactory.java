...
public abstract class AggregatorFactory {
    ...
    protected abstract Aggregator createInternal(SearchContext searchContext, Aggregator parent, CardinalityUpperBound cardinality,
     ...
     * <p>
     * It should match the types registered by calling {@linkplain org.codelibs.fesen.search.aggregations.support.AggregationUsageService}.
