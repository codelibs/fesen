...
public class RangeAggregator extends BucketsAggregator {
    ...
    public InternalAggregation buildEmptyAggregation() {
        ...
        List<org.codelibs.fesen.search.aggregations.bucket.range.Range.Bucket> buckets = new ArrayList<>(ranges.length);
        for (int i = 0; i < ranges.length; i++) {
            Range range = ranges[i];
            org.codelibs.fesen.search.aggregations.bucket.range.Range.Bucket bucket =
