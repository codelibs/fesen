 ...
 * construction using
 * {@link org.codelibs.fesen.search.builder.SearchSourceBuilder#searchSource()}.
 *
 * @see org.codelibs.fesen.action.search.SearchRequest#source(SearchSourceBuilder)
 */
public final class SearchSourceBuilder implements Writeable, ToXContentObject, Rewriteable<SearchSourceBuilder> {
     ...
     *
     * @see org.codelibs.fesen.index.query.QueryBuilders
     */
    ...
    /**
     * Should each {@link org.codelibs.fesen.search.SearchHit} be returned with
    ...
    /**
     * Should each {@link org.codelibs.fesen.search.SearchHit} be returned with a
    ...
    /**
     * Should each {@link org.codelibs.fesen.search.SearchHit} be returned with the
    ...
    /**
     * Indicates whether {@link org.codelibs.fesen.search.SearchHit}s should be returned with the
     * sequence number and primary term of the last modification of the document.
     */
