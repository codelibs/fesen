...
public class SuggestBuilder implements Writeable, ToXContentObject {
     ...
     * to be set either via this setter or via the {@link org.codelibs.fesen.search.suggest.SuggestionBuilder#text(String)} method.
     * <p>
    ...
    /**
     * Adds an {@link org.codelibs.fesen.search.suggest.SuggestionBuilder} instance under a user defined name.
