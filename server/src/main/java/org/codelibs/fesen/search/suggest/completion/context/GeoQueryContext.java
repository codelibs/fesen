...
import static org.codelibs.fesen.search.suggest.completion.context.GeoContextMapping.CONTEXT_PRECISION;
import static org.codelibs.fesen.search.suggest.completion.context.GeoContextMapping.CONTEXT_VALUE;
