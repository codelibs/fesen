...
class ValueCountAggregatorFactory extends ValuesSourceAggregatorFactory {
    ...
    ValueCountAggregatorFactory(String name, ValuesSourceConfig config, QueryShardContext queryShardContext, AggregatorFactory parent,
    ...
    protected Aggregator doCreateInternal(SearchContext searchContext, Aggregator parent, CardinalityUpperBound bucketCardinality,
        ...
        return queryShardContext.getValuesSourceRegistry().getAggregator(ValueCountAggregationBuilder.REGISTRY_KEY, config).build(name,
