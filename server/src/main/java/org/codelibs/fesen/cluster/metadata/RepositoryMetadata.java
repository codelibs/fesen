...
public class RepositoryMetadata implements Writeable {
    ...
    public RepositoryMetadata(String name, String type, Settings settings, long generation, long pendingGeneration) {
        ...
        assert generation <= pendingGeneration : "Pending generation [" + pendingGeneration + "] must be greater or equal to generation ["
                + generation + "]";
    }
     ...
     * See package level documentation for the blob store based repositories {@link org.codelibs.fesen.repositories.blobstore} for details
