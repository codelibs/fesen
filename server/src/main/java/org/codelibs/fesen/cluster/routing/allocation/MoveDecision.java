...
public final class MoveDecision extends AbstractAllocationDecision {
    ...
    public static MoveDecision rebalance(Decision canRebalanceDecision, AllocationDecision allocationDecision,
            @Nullable DiscoveryNode assignedNode, int currentNodeRanking, List<NodeAllocationResult> nodeDecisions) {
    ...
    public MoveDecision withRemainDecision(Decision canRemainDecision) {
        return new MoveDecision(canRemainDecision, clusterRebalanceDecision, allocationDecision, targetNode, nodeDecisions,
                currentNodeRanking);
    }
    ...
    public String getExplanation() {
        ...
        if (clusterRebalanceDecision != null) {
            ...
            if (allocationDecision == AllocationDecision.AWAITING_INFO) {
                ...
                explanation = "rebalancing is not allowed" + (atLeastOneNodeWithYesDecision()
    ...
    public boolean equals(Object other) {
        ...
        return Objects.equals(allocationDecision, that.allocationDecision) && Objects.equals(canRemainDecision, that.canRemainDecision)
                && Objects.equals(clusterRebalanceDecision, that.clusterRebalanceDecision) && currentNodeRanking == that.currentNodeRanking;
    }
