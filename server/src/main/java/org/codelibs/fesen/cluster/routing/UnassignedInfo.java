...
public final class UnassignedInfo implements ToXContentFragment, Writeable {
    ...
    public void writeTo(StreamOutput out) throws IOException {
        if (out.getVersion().before(Version.V_7_0_0) && reason == Reason.INDEX_CLOSED) {
    ...
    /**
     * A set of nodeIds that failed to complete allocations for this shard. {@link org.codelibs.fesen.gateway.ReplicaShardAllocator}
     ...
     *
     * @see org.codelibs.fesen.gateway.ReplicaShardAllocator#processExistingRecoveries(RoutingAllocation)
     * @see org.codelibs.fesen.cluster.routing.allocation.AllocationService#applyFailedShards(ClusterState, List, List)
     */
