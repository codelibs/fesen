...
public class MetadataIndexUpgradeService {
    ...
    /**
     * Checks if the index was already opened by this version of Fesen and doesn't require any additional checks.
     */
    ...
    /*
     * Returns true if this index can be supported by the current version of fesen
     */
