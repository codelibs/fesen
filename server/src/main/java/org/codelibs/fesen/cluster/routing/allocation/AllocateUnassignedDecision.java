...
public class AllocateUnassignedDecision extends AbstractAllocationDecision {
    ...
    private AllocateUnassignedDecision(AllocationStatus allocationStatus, DiscoveryNode assignedNode, String allocationId,
            List<NodeAllocationResult> nodeDecisions, boolean reuseStore, long remainingDelayInMillis, long configuredDelayInMillis) {
    ...
    private boolean hasNodeWithStaleOrCorruptShard() {
        return getNodeDecisions() != null && getNodeDecisions().stream().anyMatch(result -> result.getShardStoreInfo() != null
    ...
    public boolean equals(Object other) {
        ...
        return Objects.equals(allocationStatus, that.allocationStatus) && Objects.equals(allocationId, that.allocationId)
                && reuseStore == that.reuseStore && configuredDelayInMillis == that.configuredDelayInMillis
    ...
    public int hashCode() {
        return 31 * super.hashCode()
                + Objects.hash(allocationStatus, allocationId, reuseStore, configuredDelayInMillis, remainingDelayInMillis);
    }
