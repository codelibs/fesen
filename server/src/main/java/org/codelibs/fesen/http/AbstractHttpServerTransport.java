...
import static org.codelibs.fesen.http.HttpTransportSettings.SETTING_HTTP_BIND_HOST;
import static org.codelibs.fesen.http.HttpTransportSettings.SETTING_HTTP_MAX_CONTENT_LENGTH;
import static org.codelibs.fesen.http.HttpTransportSettings.SETTING_HTTP_PORT;
import static org.codelibs.fesen.http.HttpTransportSettings.SETTING_HTTP_PUBLISH_HOST;
import static org.codelibs.fesen.http.HttpTransportSettings.SETTING_HTTP_PUBLISH_PORT;
...
import org.codelibs.fesen.common.transport.NetworkExceptionHelper;
    ...
    static int resolvePublishPort(Settings settings, List<TransportAddress> boundAddresses, InetAddress publishInetAddress) {
        ...
        if (publishPort < 0) {
            throw new BindHttpException("Failed to auto-resolve http publish port, multiple bound addresses " + boundAddresses
                    ...
                    + "Please specify a unique port by setting " + SETTING_HTTP_PORT.getKey() + " or "
