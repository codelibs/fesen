...
public class JvmInfo implements ReportingService.Info {
    ...
    static {
        ...
        INSTANCE = new JvmInfo(JvmPid.getPid(), System.getProperty("java.version"), runtimeMXBean.getVmName(), runtimeMXBean.getVmVersion(),
                ...
                onOutOfMemoryError, useCompressedOops, useG1GC, useSerialGC, g1RegisionSize);
    }
    ...
    private JvmInfo(long pid, String version, String vmName, String vmVersion, String vmVendor, boolean bundledJdk, Boolean usingBundledJdk,
            ...
            String bootClassPath, String classPath, Map<String, String> systemProperties, String[] gcCollectors, String[] memoryPools,
            String onError, String onOutOfMemoryError, String useCompressedOops, String useG1GC, String useSerialGC, long g1RegionSize) {
        this.pid = pid;
