...
public class HotThreads {
    ...
    private static boolean isIdleThread(ThreadInfo threadInfo) {
        ...
        for (StackTraceElement frame : threadInfo.getStackTrace()) {
            ...
            if (className.equals("org.codelibs.fesen.threadpool.ThreadPool$CachedTimeThread") &&
                methodName.equals("run")) {
                return true;
            }
            if (className.equals("org.codelibs.fesen.indices.ttl.IndicesTTLService$Notifier") &&
