 ...
 * been cleanly written out to the repository but not yet made part of the current {@link org.codelibs.fesen.repositories.RepositoryData}
...
public final class InFlightShardSnapshotStates {
    ...
    private static boolean assertGenerationConsistency(Map<String, Map<Integer, String>> generations, String indexName, int shardId,
