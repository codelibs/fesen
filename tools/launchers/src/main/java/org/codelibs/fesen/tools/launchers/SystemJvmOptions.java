...
final class SystemJvmOptions {
    ...
    private static String javaLocaleProviders() {
         ...
         *
         *  Due to internationalization enhancements in JDK 9 Fesen need to set the provider to COMPAT otherwise time/date
         *  parsing will break in an incompatible way for some date patterns and locales.
         *  //TODO COMPAT will be deprecated in jdk14 https://bugs.openjdk.java.net/browse/JDK-8232906
         * See also: documentation in <code>server/org.codelibs.fesen.common.time.IsoCalendarDataProvider</code>
         */
