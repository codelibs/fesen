...
public class HasChildQueryBuilder extends AbstractQueryBuilder<HasChildQueryBuilder> {
    ...
    static final String MIN_CHILDREN_0_DEPRECATION_MESSAGE =
            "[min_children] 0 will be rejected " + "starting in 8.0. Using 1 instead of 0 will return the same result set.";
    ...
    protected Query doToQuery(QueryShardContext context) throws IOException {
        ...
        if (parentIdFieldMapper != null) {
            ...
            return new LateParsingQuery(parentFilter, innerQuery, minChildren(), maxChildren(), fieldType.name(), scoreMode, fieldData,
    ...
    public static final class LateParsingQuery extends Query {
        ...
        LateParsingQuery(Query toQuery, Query innerQuery, int minChildren, int maxChildren, String joinField, ScoreMode scoreMode,
        ...
        public Query rewrite(IndexReader reader) throws IOException {
            ...
            if (reader instanceof DirectoryReader) {
                ...
                return JoinUtil.createJoinQuery(joinField, innerQuery, toQuery, indexSearcher, scoreMode, ordinalMap, minChildren,
                        maxChildren);
            } else {
        ...
        public boolean equals(Object o) {
            ...
            if (maxChildren != that.maxChildren)
                return false;
            if (!toQuery.equals(that.toQuery))
                return false;
            if (!innerQuery.equals(that.innerQuery))
                return false;
            if (!joinField.equals(that.joinField))
                return false;
    ...
    protected boolean doEquals(HasChildQueryBuilder that) {
        return Objects.equals(query, that.query) && Objects.equals(type, that.type) && Objects.equals(scoreMode, that.scoreMode)
                && Objects.equals(minChildren, that.minChildren) && Objects.equals(maxChildren, that.maxChildren)
