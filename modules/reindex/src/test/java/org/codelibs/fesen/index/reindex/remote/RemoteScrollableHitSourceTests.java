...
public class RemoteScrollableHitSourceTests extends ESTestCase {
    ...
    public void testParseRejection() throws Exception {
        ...
        Consumer<Response> checkResponse = r -> {
            ...
            assertEquals("rejected execution of org.codelibs.fesen.transport.TransportService$5@52d06af2 on "
                    + "EsThreadPoolExecutor[search, queue capacity = 1000, org.codelibs.fesen.common.util.concurrent."
