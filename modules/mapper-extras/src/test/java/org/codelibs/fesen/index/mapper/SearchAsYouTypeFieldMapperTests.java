...
import org.codelibs.fesen.index.mapper.SearchAsYouTypeFieldMapper.PrefixFieldMapper;
import org.codelibs.fesen.index.mapper.SearchAsYouTypeFieldMapper.PrefixFieldType;
import org.codelibs.fesen.index.mapper.SearchAsYouTypeFieldMapper.SearchAsYouTypeAnalyzer;
import org.codelibs.fesen.index.mapper.SearchAsYouTypeFieldMapper.SearchAsYouTypeFieldType;
import org.codelibs.fesen.index.mapper.SearchAsYouTypeFieldMapper.ShingleFieldMapper;
import org.codelibs.fesen.index.mapper.SearchAsYouTypeFieldMapper.ShingleFieldType;
...
public class SearchAsYouTypeFieldMapperTests extends MapperTestCase {
    ...
    protected IndexAnalyzers createIndexAnalyzers(IndexSettings indexSettings) {
        ...
        return new IndexAnalyzers(org.codelibs.fesen.core.Map.of("default", dflt, "standard", standard, "keyword", keyword, "simple",
                simple, "whitespace", whitespace), org.codelibs.fesen.core.Map.of(), org.codelibs.fesen.core.Map.of());
    }
    ...
    public void testDefaultConfiguration() throws IOException {
        ...
        assertShingleFieldType(getShingleFieldMapper(defaultMapper, "field._2gram").fieldType(), 2, "default",
                prefixFieldMapper.fieldType());
        assertShingleFieldType(getShingleFieldMapper(defaultMapper, "field._3gram").fieldType(), 3, "default",
                prefixFieldMapper.fieldType());
    }
    ...
    public void testConfiguration() throws IOException {
        ...
        DocumentMapper defaultMapper = createDocumentMapper(fieldMapping(
        ...
        assertShingleFieldType(getShingleFieldMapper(defaultMapper, "field._2gram").fieldType(), 2, analyzerName,
                prefixFieldMapper.fieldType());
        assertShingleFieldType(getShingleFieldMapper(defaultMapper, "field._3gram").fieldType(), 3, analyzerName,
                prefixFieldMapper.fieldType());
        assertShingleFieldType(getShingleFieldMapper(defaultMapper, "field._4gram").fieldType(), 4, analyzerName,
                prefixFieldMapper.fieldType());
    }
    ...
    public void testIndexOptions() throws IOException {
        DocumentMapper mapper =
                createDocumentMapper(fieldMapping(b -> b.field("type", "search_as_you_type").field("index_options", "offsets")));
        ...
        Stream.of(getPrefixFieldMapper(mapper, "field._index_prefix"), getShingleFieldMapper(mapper, "field._2gram"),
    ...
    public void testStore() throws IOException {
        ...
        Stream.of(getPrefixFieldMapper(mapper, "field._index_prefix"), getShingleFieldMapper(mapper, "field._2gram"),
                getShingleFieldMapper(mapper, "field._3gram")).forEach(m -> assertFalse("for " + m.name(), m.fieldType.stored()));
    }

    public void testIndex() throws IOException {
        DocumentMapper mapper = createDocumentMapper(fieldMapping(b -> b.field("type", "search_as_you_type").field("index", false)));

        Stream.of(getRootFieldMapper(mapper, "field"), getPrefixFieldMapper(mapper, "field._index_prefix"),
                getShingleFieldMapper(mapper, "field._2gram"), getShingleFieldMapper(mapper, "field._3gram"))
    ...
    public void testNorms() throws IOException {
        // default setting
        {
            ...
            Stream.of(getRootFieldMapper(mapper, "field"), getShingleFieldMapper(mapper, "field._2gram"),
                    getShingleFieldMapper(mapper, "field._3gram")).forEach(m -> assertFalse("for " + m.name(), m.fieldType.omitNorms()));
        ...
        // can disable norms on search_as_you_type fields
        {
            ...
            Stream.of(getPrefixFieldMapper(mapper, "field._index_prefix"), getShingleFieldMapper(mapper, "field._2gram"),
                    getShingleFieldMapper(mapper, "field._3gram")).forEach(m -> assertTrue("for " + m.name(), m.fieldType.omitNorms()));
        }
    }
    ...
    public void testMatchPhrasePrefix() throws IOException {
...

        {
            ...
            Query expected =
                    new SynonymQuery.Builder("field._index_prefix").addTerm(new Term("field._index_prefix", "three words here")).build();
            assertThat(q, equalTo(expected));
        }
...

        {
            ...
            Query expected = new SpanNearQuery.Builder("field._3gram", true)
                    ...
                    .addClause(new FieldMaskingSpanQuery(new SpanTermQuery(new Term("field._index_prefix", "than three words")),
                            "field._3gram"))
                    .build();
            assertThat(q, equalTo(expected));
        }
    ...
    public void testMatchPhrase() throws IOException {
...

        {
            ...
            Query expected = new MultiPhraseQuery.Builder().add(new Term("field._3gram", "one two three"))
                    .add(new Term("field._3gram", "two three four")).build();
            assertThat(actual, equalTo(expected));
        }
...

        {
            ...
            Query expected = new MultiPhraseQuery.Builder().add(new Term("field._2gram", "one two"))
                    .add(new Term("field._2gram", "two three")).build();
            assertThat(actual, equalTo(expected));
        }
    ...
    public void testMultiMatchBoolPrefix() throws IOException {
        ...
        MultiMatchQueryBuilder builder =
                new MultiMatchQueryBuilder("quick brown fox jump lazy dog", "field", "field._2gram", "field._3gram", "field._4gram");
    ...
    public void testAnalyzerSerialization() throws IOException {
        ...
        assertEquals(serialized, "{\"_doc\":{\"properties\":{\"field\":"
    ...
    private static void assertSearchAsYouTypeFieldType(SearchAsYouTypeFieldType fieldType, int maxShingleSize, String analyzerName,
    ...
    private static void assertShingleFieldType(ShingleFieldType fieldType, int shingleSize, String analyzerName,
            PrefixFieldType prefixFieldType) {
