...
public class ScaledFloatFieldTypeTests extends FieldTypeTestCase {
    ...
    public void testRangeQuery() throws IOException {
        ...
        ScaledFloatFieldMapper.ScaledFloatFieldType ft = new ScaledFloatFieldMapper.ScaledFloatFieldType("scaled_float", true, false, false,
                Collections.emptyMap(), 0.1 + randomDouble() * 100, null);
    ...
    public void testFetchSourceValue() throws IOException {
        ...
        MappedFieldType nullValueMapper =
                new ScaledFloatFieldMapper.Builder("field", false, false).scalingFactor(100).nullValue(2.71).build(context).fieldType();
