...
import org.codelibs.fesen.index.mapper.RankFeatureFieldMapper.RankFeatureFieldType;
import org.codelibs.fesen.index.mapper.RankFeatureMetaFieldMapper;
import org.codelibs.fesen.index.mapper.RankFeaturesFieldMapper.RankFeaturesFieldType;
...
public final class RankFeatureQueryBuilder extends AbstractQueryBuilder<RankFeatureQueryBuilder> {
    ...
    public abstract static class ScoreFunction {
        ...
        public static class Log extends ScoreFunction {
            ...
            private static final ConstructingObjectParser<Log, Void> PARSER =
                    new ConstructingObjectParser<>("log", a -> new Log((Float) a[0]));
            static {
        ...
        public static class Saturation extends ScoreFunction {
            ...
            private static final ConstructingObjectParser<Saturation, Void> PARSER =
                    new ConstructingObjectParser<>("saturation", a -> new Saturation((Float) a[0]));
            static {
        ...
        public static class Sigmoid extends ScoreFunction {
            ...
            private static final ConstructingObjectParser<Sigmoid, Void> PARSER =
                    new ConstructingObjectParser<>("sigmoid", a -> new Sigmoid((Float) a[0], ((Float) a[1]).floatValue()));
            static {
    ...
    static {
        ...
        PARSER.declareObject(ConstructingObjectParser.optionalConstructorArg(), ScoreFunction.Saturation.PARSER,
