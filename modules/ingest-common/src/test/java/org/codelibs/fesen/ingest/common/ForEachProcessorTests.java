...
public class ForEachProcessorTests extends ESTestCase {
    ...
    public void testExecuteWithAsyncProcessor() throws Exception {
        ...
        IngestDocument ingestDocument =
                new IngestDocument("_index", "_type", "_id", null, null, null, Collections.singletonMap("values", values));
    ...
    public void testExecuteWithFailure() throws Exception {
        ...
        processor = new ForEachProcessor("_tag", null, "values",
                new CompoundProcessor(false, Arrays.asList(testProcessor), Arrays.asList(onFailureProcessor)), false);
        processor.execute(ingestDocument, (result, e) -> {});
        assertThat(testProcessor.getInvokedCounter(), equalTo(3));
        assertThat(ingestDocument.getFieldValue("values", List.class), equalTo(Arrays.asList("A", "B", "c")));
    }
    ...
    public void testRestOfTheDocumentIsAvailable() throws Exception {
        ...
        ForEachProcessor processor = new ForEachProcessor(
                "_tag", null, "values", new SetProcessor("_tag", null,
                        new TestTemplateService.MockTemplateScript.Factory("_ingest._value.new_field"), (model) -> model.get("other")),
                false);
        processor.execute(ingestDocument, (result, e) -> {});
    ...
    public void testModifyFieldsOutsideArray() throws Exception {
        ...
        ForEachProcessor processor = new ForEachProcessor("_tag", null, "values", new CompoundProcessor(false,
                org.codelibs.fesen.core.List.of(new UppercaseProcessor("_tag_upper", null, "_ingest._value", false, "_ingest._value")),
                org.codelibs.fesen.core.List
                        .of(new AppendProcessor("_tag", null, template, (model) -> (Collections.singletonList("added")), true))),
                false);
        processor.execute(ingestDocument, (result, e) -> {});
    ...
    public void testScalarValueAllowsUnderscoreValueFieldToRemainAccessible() throws Exception {
        ...
        TestProcessor processor =
                new TestProcessor(doc -> doc.setFieldValue("_ingest._value", doc.getFieldValue("_source._value", String.class)));
    ...
    public void testNestedForEach() throws Exception {
        ...
        IngestDocument ingestDocument =
                new IngestDocument("_index", "_type", "_id", null, null, null, Collections.singletonMap("values1", values));

        TestProcessor testProcessor = new TestProcessor(
                doc -> doc.setFieldValue("_ingest._value", doc.getFieldValue("_ingest._value", String.class).toUpperCase(Locale.ENGLISH)));
        ForEachProcessor processor = new ForEachProcessor("_tag", null, "values1",
                new ForEachProcessor("_tag", null, "_ingest._value.values2", testProcessor, false), false);
        processor.execute(ingestDocument, (result, e) -> {});
