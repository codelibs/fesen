...
import static org.codelibs.fesen.index.query.QueryBuilders.boolQuery;
import static org.codelibs.fesen.index.query.QueryBuilders.matchAllQuery;
import static org.codelibs.fesen.index.query.QueryBuilders.matchPhraseQuery;
import static org.codelibs.fesen.index.query.QueryBuilders.matchQuery;
import static org.codelibs.fesen.index.query.QueryBuilders.prefixQuery;
...
import static org.codelibs.fesen.index.query.QueryBuilders.termsLookupQuery;
import static org.codelibs.fesen.index.query.QueryBuilders.wildcardQuery;
import static org.codelibs.fesen.percolator.PercolatorFieldMapper.EXTRACTION_COMPLETE;
import static org.codelibs.fesen.percolator.PercolatorFieldMapper.EXTRACTION_FAILED;
import static org.codelibs.fesen.percolator.PercolatorFieldMapper.EXTRACTION_PARTIAL;
...
import org.codelibs.fesen.script.MockScriptPlugin;
...
public class PercolatorFieldMapperTests extends ESSingleNodeTestCase {
    ...
    public void init() throws Exception {
        ...
        String mapper = Strings.toString(XContentFactory.jsonBuilder().startObject().startObject("doc").startObject("properties")
                .startObject("field").field("type", "text").endObject().startObject("field1").field("type", "text").endObject()
                .startObject("field2").field("type", "text").endObject().startObject("_field3").field("type", "text").endObject()
                .startObject("field4").field("type", "text").endObject().startObject("number_field1").field("type", "integer").endObject()
                .startObject("number_field2").field("type", "long").endObject().startObject("number_field3").field("type", "long")
                .endObject().startObject("number_field4").field("type", "half_float").endObject().startObject("number_field5")
                .field("type", "float").endObject().startObject("number_field6").field("type", "double").endObject()
                .startObject("number_field7").field("type", "ip").endObject().startObject("date_field").field("type", "date").endObject()
    ...
    private void addQueryFieldMappings() throws Exception {
        ...
        String percolatorMapper = Strings.toString(XContentFactory.jsonBuilder().startObject().startObject("doc").startObject("properties")
                .startObject(fieldName).field("type", "percolator").endObject().endObject().endObject().endObject());
    ...
    public void testExtractTerms() throws Exception {
        ...
        IndexMetadata build =
                IndexMetadata.builder("").settings(Settings.builder().put(IndexMetadata.SETTING_VERSION_CREATED, Version.CURRENT))
                        .numberOfShards(1).numberOfReplicas(0).build();
        IndexSettings settings = new IndexSettings(build, Settings.EMPTY);
        ParseContext.InternalParseContext parseContext =
                new ParseContext.InternalParseContext(settings, mapperService.documentMapperParser(), documentMapper, null, null);
    ...
    public void testCreateCandidateQuery_oldIndex() throws Exception {
        ...
        t = fieldType.createCandidateQuery(indexReader, Version.V_7_0_0);
        assertTrue(t.v2());
        assertEquals(2, t.v1().clauses().size());
        assertThat(t.v1().clauses().get(0).getQuery(), instanceOf(CoveringQuery.class));
        assertThat(t.v1().clauses().get(1).getQuery(), instanceOf(TermQuery.class));
    ...
    public void testPercolatorFieldMapper() throws Exception {
        ...
        ParsedDocument doc = mapperService.documentMapper("doc")
                .parse(new SourceToParse("test", "doc", "1",
    ...
    public void testStoringQueries() throws Exception {
        addQueryFieldMappings();
        QueryBuilder[] queries = new QueryBuilder[] { termQuery("field", "value"), matchAllQuery(), matchQuery("field", "value"),
                matchPhraseQuery("field", "value"), prefixQuery("field", "v"), wildcardQuery("field", "v*"),
                rangeQuery("number_field2").gte(0).lte(9), rangeQuery("date_field").from("2015-01-01T00:00").to("2015-01-01T00:00") };
    ...
    public void testPercolatorFieldMapperUnMappedField() throws Exception {
        ...
        MapperParsingException exception = expectThrows(MapperParsingException.class, () -> {
            mapperService.documentMapper("doc")
                    .parse(new SourceToParse("test", "doc", "1", BytesReference.bytes(
    ...
    public void testPercolatorFieldMapper_noQuery() throws Exception {
        ...
        try {
            mapperService.documentMapper("doc").parse(new SourceToParse("test", "doc", "1",
                    BytesReference.bytes(XContentFactory.jsonBuilder().startObject().nullField(fieldName).endObject()), XContentType.JSON));
    ...
    public void testAllowNoAdditionalSettings() throws Exception {
        ...
        String percolatorMapper = Strings.toString(XContentFactory.jsonBuilder().startObject().startObject("doc").startObject("properties")
                .startObject(fieldName).field("type", "percolator").field("index", "no").endObject().endObject().endObject().endObject());
    ...
    public void testMultiplePercolatorFields() throws Exception {
        ...
        String percolatorMapper = Strings.toString(XContentFactory.jsonBuilder().startObject().startObject(typeName)
                .startObject("properties").startObject("query_field1").field("type", "percolator").endObject().startObject("query_field2")
                .field("type", "percolator").endObject().endObject().endObject().endObject());
        ...
        ParsedDocument doc = mapperService.documentMapper(typeName)
                .parse(new SourceToParse("test", typeName, "1", BytesReference.bytes(
    ...
    public void testNestedPercolatorField() throws Exception {
        ...
        String percolatorMapper =
                Strings.toString(XContentFactory.jsonBuilder().startObject().startObject(typeName).startObject("properties")
                        .startObject("object_field").field("type", "object").startObject("properties").startObject("query_field")
                        .field("type", "percolator").endObject().endObject().endObject().endObject().endObject().endObject());
        mapperService.merge(typeName, new CompressedXContent(percolatorMapper), MapperService.MergeReason.MAPPING_UPDATE);
        ...
        doc = mapperService
                .documentMapper(typeName).parse(
                        new SourceToParse(
                                "test", typeName, "1", BytesReference.bytes(jsonBuilder().startObject().startArray("object_field")
                                        .startObject().field("query_field", queryBuilder).endObject().endArray().endObject()),
                                XContentType.JSON));
        assertThat(doc.rootDoc().getFields().size(), equalTo(12)); // also includes all other meta fields
        ...
        MapperParsingException e = expectThrows(MapperParsingException.class, () -> {
            mapperService.documentMapper(typeName)
                    .parse(new SourceToParse("test", typeName, "1",
                            BytesReference.bytes(jsonBuilder().startObject().startArray("object_field").startObject()
                                    .field("query_field", queryBuilder).endObject().startObject().field("query_field", queryBuilder)
    ...
    public void testEmptyName() throws Exception {
        String mapping = Strings.toString(XContentFactory.jsonBuilder().startObject().startObject("type1").startObject("properties")
                .startObject("").field("type", "percolator").endObject().endObject().endObject().endObject());
        DocumentMapperParser parser = mapperService.documentMapperParser();

        IllegalArgumentException e =
                expectThrows(IllegalArgumentException.class, () -> parser.parse("type1", new CompressedXContent(mapping)));
    ...
    public void testImplicitlySetDefaultScriptLang() throws Exception {
        ...
        ParsedDocument doc = mapperService.documentMapper("doc")
                .parse(new SourceToParse("test", "doc", "1", BytesReference.bytes(XContentFactory.jsonBuilder().startObject()
                        .rawField(fieldName, new BytesArray(Strings.toString(query)).streamInput(), query.contentType()).endObject()),
                        XContentType.JSON));
        ...
        try (InputStream in = new ByteArrayInputStream(querySource.bytes, querySource.offset, querySource.length)) {
            try (StreamInput input = new NamedWriteableAwareStreamInput(new InputStreamStreamInput(in), writableRegistry())) {
                ...
                ScriptScoreFunctionBuilder function =
                        (ScriptScoreFunctionBuilder) queryBuilder.filterFunctionBuilders()[0].getScoreFunction();
    ...
    public void testDuplicatedClauses() throws Exception {
        ...
        ParsedDocument doc = mapperService.documentMapper("doc").parse(new SourceToParse("test", "doc", "1",
                BytesReference.bytes(XContentFactory.jsonBuilder().startObject().field(fieldName, qb).endObject()), XContentType.JSON));

        List<String> values = Arrays.stream(doc.rootDoc().getFields(fieldType.queryTermsField.name()))
                .map(f -> f.binaryValue().utf8ToString()).sorted().collect(Collectors.toList());
        ...
        values = Arrays.stream(doc.rootDoc().getFields(fieldType.queryTermsField.name())).map(f -> f.binaryValue().utf8ToString()).sorted()
        ...
        qb = boolQuery().minimumShouldMatch(3).should(boolQuery().should(termQuery("field", "value1")).should(termQuery("field", "value2")))
