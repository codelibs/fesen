...
public class MultiSearchTemplateRequestTests extends ESTestCase {
    ...
    public void testParseRequest() throws Exception {
        byte[] data = StreamsUtils.copyToBytesFromClasspath("/org/codelibs/fesen/script/mustache/simple-msearch-template.json");
    ...
    public void testParseWithCarriageReturn() throws Exception {
        ...
        RestRequest restRequest =
                new FakeRestRequest.Builder(xContentRegistry()).withContent(new BytesArray(content), XContentType.JSON).build();
    ...
    public void testMultiSearchTemplateToJson() throws Exception {
        ...
        RestRequest restRequest =
                new FakeRestRequest.Builder(xContentRegistry()).withContent(new BytesArray(serialized), XContentType.JSON).build();
