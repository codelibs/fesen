...
import org.codelibs.fesen.common.blobstore.BlobStoreException;
...
public class URLBlobStore implements BlobStore {
    ...
    public URLBlobStore(Settings settings, URL path) {
        ...
        this.bufferSizeInBytes =
                (int) settings.getAsBytesSize("repositories.uri.buffer_size", new ByteSizeValue(100, ByteSizeUnit.KB)).getBytes();
    }
