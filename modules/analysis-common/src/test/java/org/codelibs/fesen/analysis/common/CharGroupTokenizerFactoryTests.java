...
public class CharGroupTokenizerFactoryTests extends ESTokenStreamTestCase {
    ...
    public void testParseTokenChars() {
        ...
        for (String[] conf : Arrays.asList(new String[] { "\\v" }, new String[] { "\\u00245" }, new String[] { "commas" },
                new String[] { "a", "b", "c", "\\$" })) {
        ...
        for (String[] conf : Arrays.asList(new String[0], new String[] { "\\n" }, new String[] { "\\u0024" }, new String[] { "whitespace" },
                new String[] { "a", "b", "c" }, new String[] { "a", "b", "c", "\\r" }, new String[] { "\\r" },
    ...
    public void testMaxTokenLength() throws IOException {
        ...
        CharTokenizer tokenizer =
                (CharTokenizer) new CharGroupTokenizerFactory(indexProperties, null, name, defaultLengthSettings).create();
        ...
        final Settings analysisSettings =
                newAnalysisSettingsBuilder().putList("tokenize_on_chars", conf).put("max_token_length", 2).build();
        ...
        final Settings tooLongLengthSettings =
                newAnalysisSettingsBuilder().putList("tokenize_on_chars", conf).put("max_token_length", 1024 * 1024 + 1).build();
        ...
        final Settings negativeLengthSettings =
                newAnalysisSettingsBuilder().putList("tokenize_on_chars", conf).put("max_token_length", -1).build();
    ...
    public void testTokenization() throws IOException {
        ...
        Tokenizer tokenizer =
                new CharGroupTokenizerFactory(IndexSettingsModule.newIndexSettings(index, indexSettings), null, name, settings).create();
