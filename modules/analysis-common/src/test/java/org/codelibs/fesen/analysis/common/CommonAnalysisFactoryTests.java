...
import org.codelibs.fesen.analysis.common.ASCIIFoldingTokenFilterFactory;
import org.codelibs.fesen.analysis.common.ApostropheFilterFactory;
import org.codelibs.fesen.analysis.common.ArabicNormalizationFilterFactory;
import org.codelibs.fesen.analysis.common.ArabicStemTokenFilterFactory;
import org.codelibs.fesen.analysis.common.BengaliNormalizationFilterFactory;
import org.codelibs.fesen.analysis.common.BrazilianStemTokenFilterFactory;
import org.codelibs.fesen.analysis.common.CJKBigramFilterFactory;
import org.codelibs.fesen.analysis.common.CJKWidthFilterFactory;
import org.codelibs.fesen.analysis.common.ClassicFilterFactory;
import org.codelibs.fesen.analysis.common.ClassicTokenizerFactory;
import org.codelibs.fesen.analysis.common.CommonAnalysisPlugin;
import org.codelibs.fesen.analysis.common.CommonGramsTokenFilterFactory;
import org.codelibs.fesen.analysis.common.CzechStemTokenFilterFactory;
import org.codelibs.fesen.analysis.common.DecimalDigitFilterFactory;
import org.codelibs.fesen.analysis.common.DelimitedPayloadTokenFilterFactory;
import org.codelibs.fesen.analysis.common.DictionaryCompoundWordTokenFilterFactory;
import org.codelibs.fesen.analysis.common.EdgeNGramTokenFilterFactory;
import org.codelibs.fesen.analysis.common.EdgeNGramTokenizerFactory;
import org.codelibs.fesen.analysis.common.ElisionTokenFilterFactory;
import org.codelibs.fesen.analysis.common.FingerprintTokenFilterFactory;
import org.codelibs.fesen.analysis.common.FlattenGraphTokenFilterFactory;
import org.codelibs.fesen.analysis.common.GermanNormalizationFilterFactory;
import org.codelibs.fesen.analysis.common.GermanStemTokenFilterFactory;
import org.codelibs.fesen.analysis.common.HindiNormalizationFilterFactory;
import org.codelibs.fesen.analysis.common.HtmlStripCharFilterFactory;
import org.codelibs.fesen.analysis.common.HyphenationCompoundWordTokenFilterFactory;
import org.codelibs.fesen.analysis.common.IndicNormalizationFilterFactory;
import org.codelibs.fesen.analysis.common.KStemTokenFilterFactory;
import org.codelibs.fesen.analysis.common.KeepTypesFilterFactory;
import org.codelibs.fesen.analysis.common.KeepWordFilterFactory;
import org.codelibs.fesen.analysis.common.KeywordMarkerTokenFilterFactory;
import org.codelibs.fesen.analysis.common.KeywordTokenizerFactory;
import org.codelibs.fesen.analysis.common.LengthTokenFilterFactory;
import org.codelibs.fesen.analysis.common.LetterTokenizerFactory;
import org.codelibs.fesen.analysis.common.LowerCaseTokenFilterFactory;
import org.codelibs.fesen.analysis.common.MappingCharFilterFactory;
import org.codelibs.fesen.analysis.common.MinHashTokenFilterFactory;
import org.codelibs.fesen.analysis.common.NGramTokenFilterFactory;
import org.codelibs.fesen.analysis.common.NGramTokenizerFactory;
...
import org.codelibs.fesen.analysis.common.PatternReplaceCharFilterFactory;
import org.codelibs.fesen.analysis.common.PatternReplaceTokenFilterFactory;
import org.codelibs.fesen.analysis.common.PatternTokenizerFactory;
import org.codelibs.fesen.analysis.common.PersianNormalizationFilterFactory;
import org.codelibs.fesen.analysis.common.PorterStemTokenFilterFactory;
import org.codelibs.fesen.analysis.common.ReverseTokenFilterFactory;
import org.codelibs.fesen.analysis.common.ScandinavianFoldingFilterFactory;
import org.codelibs.fesen.analysis.common.ScandinavianNormalizationFilterFactory;
import org.codelibs.fesen.analysis.common.SerbianNormalizationFilterFactory;
import org.codelibs.fesen.analysis.common.SimplePatternSplitTokenizerFactory;
import org.codelibs.fesen.analysis.common.SimplePatternTokenizerFactory;
import org.codelibs.fesen.analysis.common.SnowballTokenFilterFactory;
import org.codelibs.fesen.analysis.common.SoraniNormalizationFilterFactory;
import org.codelibs.fesen.analysis.common.StemmerOverrideTokenFilterFactory;
import org.codelibs.fesen.analysis.common.StemmerTokenFilterFactory;
import org.codelibs.fesen.analysis.common.SynonymGraphTokenFilterFactory;
import org.codelibs.fesen.analysis.common.SynonymTokenFilterFactory;
import org.codelibs.fesen.analysis.common.ThaiTokenizerFactory;
import org.codelibs.fesen.analysis.common.TrimTokenFilterFactory;
import org.codelibs.fesen.analysis.common.TruncateTokenFilterFactory;
import org.codelibs.fesen.analysis.common.UAX29URLEmailTokenizerFactory;
import org.codelibs.fesen.analysis.common.UpperCaseTokenFilterFactory;
import org.codelibs.fesen.analysis.common.WhitespaceTokenizerFactory;
import org.codelibs.fesen.analysis.common.WordDelimiterGraphTokenFilterFactory;
import org.codelibs.fesen.analysis.common.WordDelimiterTokenFilterFactory;
