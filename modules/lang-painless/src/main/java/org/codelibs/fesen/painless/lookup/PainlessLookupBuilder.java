...
package org.codelibs.fesen.painless.lookup;
...
import org.codelibs.fesen.painless.spi.WhitelistClass;
import org.codelibs.fesen.painless.spi.WhitelistClassBinding;
import org.codelibs.fesen.painless.spi.WhitelistConstructor;
import org.codelibs.fesen.painless.spi.WhitelistField;
import org.codelibs.fesen.painless.spi.WhitelistInstanceBinding;
import org.codelibs.fesen.painless.spi.WhitelistMethod;
import org.codelibs.fesen.painless.spi.annotation.InjectConstantAnnotation;
import org.codelibs.fesen.painless.spi.annotation.NoImportAnnotation;
...
import static org.codelibs.fesen.painless.WriterConstants.OBJECT_TYPE;
import static org.codelibs.fesen.painless.lookup.PainlessLookupUtility.DEF_CLASS_NAME;
import static org.codelibs.fesen.painless.lookup.PainlessLookupUtility.buildPainlessConstructorKey;
import static org.codelibs.fesen.painless.lookup.PainlessLookupUtility.buildPainlessFieldKey;
import static org.codelibs.fesen.painless.lookup.PainlessLookupUtility.buildPainlessMethodKey;
import static org.codelibs.fesen.painless.lookup.PainlessLookupUtility.typeToCanonicalTypeName;
import static org.codelibs.fesen.painless.lookup.PainlessLookupUtility.typeToJavaType;
import static org.codelibs.fesen.painless.lookup.PainlessLookupUtility.typesToCanonicalTypeNames;
    ...
    private void generateBridgeMethod(PainlessClassBuilder painlessClassBuilder, PainlessMethod painlessMethod) {
        ...
        if (bridgePainlessMethod == null) {
            ...
            String bridgeClassName =
                    "org/codelibs/fesen/painless/Bridge$" + javaMethod.getDeclaringClass().getSimpleName() + "$" + javaMethod.getName();
