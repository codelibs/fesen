...
import org.codelibs.fesen.painless.AnalyzerCaster;
import org.codelibs.fesen.painless.CompilerSettings;
import org.codelibs.fesen.painless.FunctionRef;
import org.codelibs.fesen.painless.Location;
import org.codelibs.fesen.painless.Operation;
import org.codelibs.fesen.painless.lookup.PainlessCast;
import org.codelibs.fesen.painless.lookup.PainlessClassBinding;
import org.codelibs.fesen.painless.lookup.PainlessConstructor;
import org.codelibs.fesen.painless.lookup.PainlessField;
import org.codelibs.fesen.painless.lookup.PainlessInstanceBinding;
import org.codelibs.fesen.painless.lookup.PainlessLookupUtility;
import org.codelibs.fesen.painless.lookup.PainlessMethod;
...
import org.codelibs.fesen.painless.spi.annotation.NonDeterministicAnnotation;
import org.codelibs.fesen.painless.symbol.Decorations;
import org.codelibs.fesen.painless.symbol.FunctionTable;
import org.codelibs.fesen.painless.symbol.ScriptScope;
import org.codelibs.fesen.painless.symbol.SemanticScope;
import org.codelibs.fesen.painless.symbol.Decorations.AllEscape;
import org.codelibs.fesen.painless.symbol.Decorations.AnyBreak;
import org.codelibs.fesen.painless.symbol.Decorations.AnyContinue;
import org.codelibs.fesen.painless.symbol.Decorations.BeginLoop;
import org.codelibs.fesen.painless.symbol.Decorations.BinaryType;
import org.codelibs.fesen.painless.symbol.Decorations.CapturesDecoration;
import org.codelibs.fesen.painless.symbol.Decorations.ComparisonType;
import org.codelibs.fesen.painless.symbol.Decorations.CompoundType;
import org.codelibs.fesen.painless.symbol.Decorations.ContinuousLoop;
import org.codelibs.fesen.painless.symbol.Decorations.DefOptimized;
import org.codelibs.fesen.painless.symbol.Decorations.DowncastPainlessCast;
import org.codelibs.fesen.painless.symbol.Decorations.EncodingDecoration;
import org.codelibs.fesen.painless.symbol.Decorations.Explicit;
import org.codelibs.fesen.painless.symbol.Decorations.ExpressionPainlessCast;
import org.codelibs.fesen.painless.symbol.Decorations.GetterPainlessMethod;
import org.codelibs.fesen.painless.symbol.Decorations.InLoop;
import org.codelibs.fesen.painless.symbol.Decorations.InstanceType;
import org.codelibs.fesen.painless.symbol.Decorations.Internal;
import org.codelibs.fesen.painless.symbol.Decorations.IterablePainlessMethod;
import org.codelibs.fesen.painless.symbol.Decorations.LastLoop;
import org.codelibs.fesen.painless.symbol.Decorations.LastSource;
import org.codelibs.fesen.painless.symbol.Decorations.ListShortcut;
import org.codelibs.fesen.painless.symbol.Decorations.LoopEscape;
import org.codelibs.fesen.painless.symbol.Decorations.MapShortcut;
import org.codelibs.fesen.painless.symbol.Decorations.MethodEscape;
import org.codelibs.fesen.painless.symbol.Decorations.MethodNameDecoration;
import org.codelibs.fesen.painless.symbol.Decorations.Negate;
import org.codelibs.fesen.painless.symbol.Decorations.ParameterNames;
import org.codelibs.fesen.painless.symbol.Decorations.PartialCanonicalTypeName;
import org.codelibs.fesen.painless.symbol.Decorations.Read;
import org.codelibs.fesen.painless.symbol.Decorations.ReferenceDecoration;
import org.codelibs.fesen.painless.symbol.Decorations.ReturnType;
import org.codelibs.fesen.painless.symbol.Decorations.SemanticVariable;
import org.codelibs.fesen.painless.symbol.Decorations.SetterPainlessMethod;
import org.codelibs.fesen.painless.symbol.Decorations.ShiftType;
import org.codelibs.fesen.painless.symbol.Decorations.Shortcut;
import org.codelibs.fesen.painless.symbol.Decorations.StandardConstant;
import org.codelibs.fesen.painless.symbol.Decorations.StandardLocalFunction;
import org.codelibs.fesen.painless.symbol.Decorations.StandardPainlessClassBinding;
import org.codelibs.fesen.painless.symbol.Decorations.StandardPainlessConstructor;
import org.codelibs.fesen.painless.symbol.Decorations.StandardPainlessField;
import org.codelibs.fesen.painless.symbol.Decorations.StandardPainlessInstanceBinding;
import org.codelibs.fesen.painless.symbol.Decorations.StandardPainlessMethod;
import org.codelibs.fesen.painless.symbol.Decorations.StaticType;
import org.codelibs.fesen.painless.symbol.Decorations.TargetType;
import org.codelibs.fesen.painless.symbol.Decorations.TypeParameters;
import org.codelibs.fesen.painless.symbol.Decorations.UnaryType;
import org.codelibs.fesen.painless.symbol.Decorations.UpcastPainlessCast;
import org.codelibs.fesen.painless.symbol.Decorations.ValueType;
import org.codelibs.fesen.painless.symbol.Decorations.Write;
import org.codelibs.fesen.painless.symbol.FunctionTable.LocalFunction;
import org.codelibs.fesen.painless.symbol.SemanticScope.FunctionScope;
import org.codelibs.fesen.painless.symbol.SemanticScope.LambdaScope;
import org.codelibs.fesen.painless.symbol.SemanticScope.Variable;

import static org.codelibs.fesen.painless.lookup.PainlessLookupUtility.typeToCanonicalTypeName;
import static org.codelibs.fesen.painless.symbol.SemanticScope.newFunctionScope;
    ...
    public void visitRegex(ERegex userRegexNode, SemanticScope semanticScope) {
        ...
        if (semanticScope.getScriptScope().getCompilerSettings().areRegexesEnabled() == CompilerSettings.RegexEnabled.FALSE) {
            throw userRegexNode.createError(new IllegalStateException("Regexes are disabled. Set [script.painless.regex.enabled] to [true] "
                    + "in fesen.yaml to allow them. Be careful though, regexes break out of Painless's protection against deep "
