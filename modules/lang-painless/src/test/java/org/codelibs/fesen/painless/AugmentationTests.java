...
public class AugmentationTests extends ScriptTestCase {
    ...
    protected Map<ScriptContext<?>, List<Whitelist>> scriptContexts() {
        ...
        digestWhitelist.add(WhitelistLoader.loadFromResourceFiles(Whitelist.class, "org.codelibs.fesen.ingest.txt"));
    ...
    public void testFeatureTest() {
        assertEquals(5, exec("org.codelibs.fesen.painless.FeatureTestObject ft = new org.codelibs.fesen.painless.FeatureTestObject();" +
            " ft.setX(3); ft.setY(2); return ft.getTotal()"));
        assertEquals(5, exec("def ft = new org.codelibs.fesen.painless.FeatureTestObject();" +
            " ft.setX(3); ft.setY(2); return ft.getTotal()"));
        assertEquals(8, exec("org.codelibs.fesen.painless.FeatureTestObject ft = new org.codelibs.fesen.painless.FeatureTestObject();" +
            " ft.setX(3); ft.setY(2); return ft.addToTotal(3)"));
        assertEquals(8, exec("def ft = new org.codelibs.fesen.painless.FeatureTestObject();" +
            " ft.setX(3); ft.setY(2); return ft.addToTotal(3)"));
    }
