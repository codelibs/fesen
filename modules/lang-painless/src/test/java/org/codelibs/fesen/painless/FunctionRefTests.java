...
public class FunctionRefTests extends ScriptTestCase {
    ...
    public void testQualifiedStaticMethodReference() {
        assertEquals(true,
                exec("List l = [true]; l.stream().map(org.codelibs.fesen.painless.FeatureTestObject::overloadedStatic).findFirst().get()"));
    }

    public void testQualifiedStaticMethodReferenceDef() {
        assertEquals(true,
                exec("def l = [true]; l.stream().map(org.codelibs.fesen.painless.FeatureTestObject::overloadedStatic).findFirst().get()"));
    }
    ...
    public void testCapturingMethodReferenceMultipleLambdas() {
        assertEquals("testingcdefg", exec(
                "String x = 'testing';" +
                "String y = 'abcdefg';" +
                "org.codelibs.fesen.painless.FeatureTestObject test = new org.codelibs.fesen.painless.FeatureTestObject(2,3);" +
    ...
    public void testCapturingMethodReferenceMultipleLambdasDefInterface() {
        assertEquals("testingcdefg", exec(
                "String x = 'testing';" +
                "String y = 'abcdefg';" +
                "def test = new org.codelibs.fesen.painless.FeatureTestObject(2,3);" +
                "return test.twoFunctionsOfX(x::concat, y::substring);"));
    }
