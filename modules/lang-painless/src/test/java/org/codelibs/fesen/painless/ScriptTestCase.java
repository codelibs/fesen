...
import org.codelibs.fesen.painless.PainlessScriptEngine;
import org.codelibs.fesen.painless.antlr.Walker;
...
import static org.codelibs.fesen.painless.action.PainlessExecuteAction.PainlessTestScript;
...
public abstract class ScriptTestCase extends ESTestCase {
    ...
    protected Map<ScriptContext<?>, List<Whitelist>> scriptContexts() {
        ...
        whitelists.add(WhitelistLoader.loadFromResourceFiles(Whitelist.class, "org.codelibs.fesen.painless.test"));
