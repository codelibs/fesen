...
public class InjectionTests extends ScriptTestCase {
    ...
    public void testInjection() {
        assertEquals(16,
                exec("org.codelibs.fesen.painless.FeatureTestObject.staticNumberArgument(8);"));
    }

    public void testInstanceInjection() {
        assertEquals(1000,
                exec("org.codelibs.fesen.painless.FeatureTestObject f = new org.codelibs.fesen.painless.FeatureTestObject(100, 0); " +
                        "f.injectTimesX(5)"));
    }
    ...
    public void testInstanceInjectWithDefLambda() {
        assertEquals(2000,
                exec("def f = new org.codelibs.fesen.painless.FeatureTestObject(100, 0); f.injectWithLambda(x -> 2*x, (short)5)"));
    }

    public void testInjectionOnDefNoInject() {
        assertEquals(1000,
                exec("def d = new org.codelibs.fesen.painless.FeatureTestObject(100, 0); d.injectTimesX((short)5)"));
    }

    public void testInjectionOnMethodReference() {
        assertEquals(60,
                exec(
                        "def ft0 = new org.codelibs.fesen.painless.FeatureTestObject(2, 0); " +
                                "org.codelibs.fesen.painless.FeatureTestObject ft1 = " +
                                "       new org.codelibs.fesen.painless.FeatureTestObject(1000, 0); " +
    ...
    public void testInjectionOnMethodReference2() {
        assertEquals(60,
                exec(
                        "org.codelibs.fesen.painless.FeatureTestObject ft0 = new org.codelibs.fesen.painless.FeatureTestObject(2, 0); " +
                                "def ft1 = new org.codelibs.fesen.painless.FeatureTestObject(1000, 0); " +
                                "ft1.timesSupplier(ft0::injectTimesX, (short)3, 5)"));
    }
    ...
    public void testAugmentedInstanceInjectWithDefLambda() {
        assertEquals(2000,
                exec("def f = new org.codelibs.fesen.painless.FeatureTestObject(100, 0); f.augmentInjectWithLambda(x -> 2*x, (short)5)"));
    }

    public void testAugmentedInjectionOnDefNoInject() {
        assertEquals(1000,
                exec("def d = new org.codelibs.fesen.painless.FeatureTestObject(100, 0); d.augmentInjectTimesX((short)5)"));
    }
    ...
    public void testMultiInjectionOnDefNoMultiInject() {
        assertEquals(6000,
                exec("def d = new org.codelibs.fesen.painless.FeatureTestObject(100, 0); d.injectMultiTimesX((short)5)"));
    }
    ...
    public void testAugmentedInstanceMultiInjectWithDefLambda() {
        assertEquals(20000,
                exec("def f = new org.codelibs.fesen.painless.FeatureTestObject(100, 0); " +
                        "f.augmentInjectMultiWithLambda(x -> 2*x, (short)5)"));
    }

    public void testAugmentedMultiInjectionOnDefNoMultiInject() {
        assertEquals(5000,
                exec("def d = new org.codelibs.fesen.painless.FeatureTestObject(100, 0); d.augmentInjectMultiTimesX((short)5)"));
    }
