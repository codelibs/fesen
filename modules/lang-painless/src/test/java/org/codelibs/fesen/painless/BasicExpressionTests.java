...
public class BasicExpressionTests extends ScriptTestCase {
    ...
    public void testNullSafeDeref() {
        ...
        //   Read shortcut
        assertMustBeNullable(    "org.codelibs.fesen.painless.FeatureTestObject a = null; return a?.x");
        assertMustBeNullable(
                "org.codelibs.fesen.painless.FeatureTestObject a = new org.codelibs.fesen.painless.FeatureTestObject(); return a?.x");
        assertNull(         exec("def    a = null;  return a?.x"));
        assertEquals(0,     exec("def    a = new org.codelibs.fesen.painless.FeatureTestObject(); return a?.x"));
...
//        assertEquals(null, exec("org.codelibs.fesen.painless.FeatureTestObject a = null; return a?.x"));            // Read field
//        assertEquals(null, exec("org.codelibs.fesen.painless.FeatureTestObject a = null; a?.x = 7; return a?.x"));  // Write field
