...
public class OverloadTests extends ScriptTestCase {
    ...
    public void testConstructor() {
        assertEquals(true, exec("org.codelibs.fesen.painless.FeatureTestObject f = new org.codelibs.fesen.painless.FeatureTestObject();" +
                                "return f.x == 0 && f.y == 0;"));
        assertEquals(true, exec("org.codelibs.fesen.painless.FeatureTestObject f = new org.codelibs.fesen.painless.FeatureTestObject(1, 2);" +
                                "return f.x == 1 && f.y == 2;"));
    }
    
    public void testStatic() {
        assertEquals(true, exec("return org.codelibs.fesen.painless.FeatureTestObject.overloadedStatic();"));
        assertEquals(false, exec("return org.codelibs.fesen.painless.FeatureTestObject.overloadedStatic(false);"));
    }
}
