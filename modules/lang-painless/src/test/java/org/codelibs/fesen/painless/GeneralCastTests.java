...
public class GeneralCastTests extends ScriptTestCase {
    ...
    public void testBoxedDefCalls() {
        ...
        assertEquals(2, exec("def f = new org.codelibs.fesen.painless.FeatureTestObject(); f.i = (byte)2; f.i"));
        assertEquals(4.0, exec(
                "def x = new org.codelibs.fesen.painless.FeatureTestObject(); " +
                "Byte i = Byte.valueOf(3); " +
                "byte j = 1;" +
                "Short s = Short.valueOf(-2);" +
                "x.mixedAdd(j, i, (char)2, s)"
        ));
        assertNull(exec("def f = new org.codelibs.fesen.painless.FeatureTestObject(); f.i = null; f.i"));
