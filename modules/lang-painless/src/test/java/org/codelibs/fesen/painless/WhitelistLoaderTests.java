...
import org.codelibs.fesen.painless.spi.annotation.DeprecatedAnnotation;
...
public class WhitelistLoaderTests extends ScriptTestCase {
    public void testUnknownAnnotations() {
        ...
        RuntimeException expected = expectThrows(RuntimeException.class, () -> {
            WhitelistLoader.loadFromResourceFiles(Whitelist.class, parsers, "org.codelibs.fesen.painless.annotation.unknown");
        });
        assertEquals(
        ...
        expected = expectThrows(RuntimeException.class, () -> {
            WhitelistLoader.loadFromResourceFiles(Whitelist.class, parsers, "org.codelibs.fesen.painless.annotation.unknown_with_options");
        });
        assertEquals(
    ...
    public void testAnnotations() {
        ...
        Whitelist whitelist = WhitelistLoader.loadFromResourceFiles(Whitelist.class, parsers, "org.codelibs.fesen.painless.annotation");
