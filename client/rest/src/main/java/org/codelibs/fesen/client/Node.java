...
public class Node {
    ...
    /**
     * Version of Fesen that the node is running or {@code null}
     * if we don't know the version.
     */
    private final String version;
    /**
     * Roles that the Fesen process on the host has or {@code null}
    ...
    /**
     * Role information about an Fesen process.
     */
