...
public final class Request {
    ...
    /**
     * Set the portion of an HTTP request to Fesen that can be
     * manipulated without changing Fesen's behavior.
     */
    ...
    /**
     * Get the portion of an HTTP request to Fesen that can be
     * manipulated without changing Fesen's behavior.
     */
