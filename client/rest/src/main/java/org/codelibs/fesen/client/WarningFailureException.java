...
import static org.codelibs.fesen.client.ResponseException.buildMessage;
...
// if the exception is not of type FesenException or RuntimeException it will be wrapped in a UncategorizedExecutionException
