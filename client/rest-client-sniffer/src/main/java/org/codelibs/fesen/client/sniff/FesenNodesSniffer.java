...
public final class FesenNodesSniffer implements NodesSniffer {
    ...
    private static final Log logger = LogFactory.getLog(FesenNodesSniffer.class);
     ...
     */
    public FesenNodesSniffer(RestClient restClient) {
        this(restClient, DEFAULT_SNIFF_REQUEST_TIMEOUT, FesenNodesSniffer.Scheme.HTTP);
    }
    ...
    private static Node readNode(String nodeId, JsonParser parser, Scheme scheme) throws IOException {
         ...
         * address on which it is listening. This is useful in Fesen's
