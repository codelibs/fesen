...
public class TimeValueTests extends ESTestCase {
    ...
    public void testRejectsNegativeValuesDuringParsing() {
        ...
        IllegalArgumentException ex =
                expectThrows(IllegalArgumentException.class, () -> TimeValue.parseTimeValue(negativeTimeValueString, settingName));
        assertThat(ex.getMessage(), equalTo("failed to parse setting [" + settingName + "] with value [" + negativeTimeValueString
    ...
    private TimeUnit randomTimeUnitObject() {
        return randomFrom(TimeUnit.NANOSECONDS, TimeUnit.MICROSECONDS, TimeUnit.MILLISECONDS, TimeUnit.SECONDS, TimeUnit.MINUTES,
