...
import static org.codelibs.fesen.common.ssl.SslConfigurationKeys.CERTIFICATE;
import static org.codelibs.fesen.common.ssl.SslConfigurationKeys.CERTIFICATE_AUTHORITIES;
import static org.codelibs.fesen.common.ssl.SslConfigurationKeys.CIPHERS;
import static org.codelibs.fesen.common.ssl.SslConfigurationKeys.CLIENT_AUTH;
import static org.codelibs.fesen.common.ssl.SslConfigurationKeys.KEY;
import static org.codelibs.fesen.common.ssl.SslConfigurationKeys.KEYSTORE_ALGORITHM;
import static org.codelibs.fesen.common.ssl.SslConfigurationKeys.KEYSTORE_LEGACY_KEY_PASSWORD;
import static org.codelibs.fesen.common.ssl.SslConfigurationKeys.KEYSTORE_LEGACY_PASSWORD;
import static org.codelibs.fesen.common.ssl.SslConfigurationKeys.KEYSTORE_PATH;
import static org.codelibs.fesen.common.ssl.SslConfigurationKeys.KEYSTORE_SECURE_KEY_PASSWORD;
import static org.codelibs.fesen.common.ssl.SslConfigurationKeys.KEYSTORE_SECURE_PASSWORD;
import static org.codelibs.fesen.common.ssl.SslConfigurationKeys.KEYSTORE_TYPE;
import static org.codelibs.fesen.common.ssl.SslConfigurationKeys.KEY_LEGACY_PASSPHRASE;
import static org.codelibs.fesen.common.ssl.SslConfigurationKeys.KEY_SECURE_PASSPHRASE;
import static org.codelibs.fesen.common.ssl.SslConfigurationKeys.PROTOCOLS;
import static org.codelibs.fesen.common.ssl.SslConfigurationKeys.TRUSTSTORE_ALGORITHM;
import static org.codelibs.fesen.common.ssl.SslConfigurationKeys.TRUSTSTORE_LEGACY_PASSWORD;
import static org.codelibs.fesen.common.ssl.SslConfigurationKeys.TRUSTSTORE_PATH;
import static org.codelibs.fesen.common.ssl.SslConfigurationKeys.TRUSTSTORE_SECURE_PASSWORD;
import static org.codelibs.fesen.common.ssl.SslConfigurationKeys.TRUSTSTORE_TYPE;
import static org.codelibs.fesen.common.ssl.SslConfigurationKeys.VERIFICATION_MODE;
...
public abstract class SslConfigurationLoader {
    ...
    static final List<String> DEFAULT_PROTOCOLS = Collections
            .unmodifiableList(ORDERED_PROTOCOL_ALGORITHM_MAP.containsKey("TLSv1.3") ? Arrays.asList("TLSv1.3", "TLSv1.2", "TLSv1.1")
    ...
    private SslKeyConfig buildKeyConfig(Path basePath) {
        ...
        if (certificatePath != null || keyPath != null) {
            ...
            if (certificatePath == null) {
                throw new SslConfigException("cannot specify [" + settingPrefix + KEYSTORE_PATH + "] without also setting [" + settingPrefix
                        + CERTIFICATE + "]");
            }
