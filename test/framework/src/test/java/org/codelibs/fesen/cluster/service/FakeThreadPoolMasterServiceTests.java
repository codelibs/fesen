...
public class FakeThreadPoolMasterServiceTests extends ESTestCase {
    ...
    public void testFakeMasterService() {
        ...
        FakeThreadPoolMasterService masterService =
                new FakeThreadPoolMasterService("test_node", "test", mockThreadPool, runnableTasks::add);
        ...
        masterService.submitStateUpdateTask("test1", new ClusterStateUpdateTask() {
            ...
            public ClusterState execute(ClusterState currentState) {
                return ClusterState.builder(currentState).metadata(Metadata.builder(currentState.metadata()).put(indexBuilder("test1")))
                        .build();
            }
        ...
        masterService.submitStateUpdateTask("test2", new ClusterStateUpdateTask() {
            @Override
            public ClusterState execute(ClusterState currentState) {
                return ClusterState.builder(currentState).metadata(Metadata.builder(currentState.metadata()).put(indexBuilder("test2")))
                        .build();
            }
