...
public class SkipSectionTests extends AbstractClientYamlTestFragmentParserTestCase {
    ...
    public void testSkip() {
        SkipSection section = new SkipSection("7.0.0 - 7.1.0",
                randomBoolean() ? Collections.emptyList() : Collections.singletonList("warnings"), "foobar");
        assertFalse(section.skip(Version.CURRENT));
        assertTrue(section.skip(Version.V_7_0_0));
        section = new SkipSection(randomBoolean() ? null : "7.0.0 - 7.1.0", Collections.singletonList("boom"), "foobar");
    ...
    public void testParseSkipSectionVersionNoFeature() throws Exception {
        parser = createParser(YamlXContent.yamlXContent, "version:     \" - 7.1.1\"\n" + "reason:      Delete ignores the parent param");
        ...
        assertThat(skipSection.getUpperVersion(), equalTo(Version.V_7_1_1));
