...
import static org.codelibs.fesen.test.AbstractQueryTestCase.alterateQueries;
...
/**
 * Various test for {@link org.codelibs.fesen.test.AbstractQueryTestCase}
 */
public class AbstractQueryTestCaseTests extends ESTestCase {
    ...
    public void testAlterateQueries() throws IOException {
        ...
        assertAlterations(alterations, allOf(hasEntry("{\"newField\":{\"term\":{\"field\":\"value\"}}}", true),
        ...
        assertAlterations(alterations,
                allOf(hasEntry("{\"newField\":{\"bool\":{\"must\":[{\"match\":{\"field\":\"value\"}}]}}}", true),
    ...
    public void testAlterateQueriesWithArbitraryContent() throws IOException {
        ...
        Set<String> queries = Sets.newHashSet("{\"query\":{\"script\":\"test\",\"params\":{\"foo\":\"bar\"}}}",
        ...
        assertAlterations(alterations,
                allOf(hasEntry("{\"newField\":{\"query\":{\"script\":\"test\",\"params\":{\"foo\":\"bar\"}}}}", true),
