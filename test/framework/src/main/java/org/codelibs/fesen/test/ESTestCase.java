...
import org.codelibs.fesen.common.joda.JodaDeprecationPatterns;
import org.codelibs.fesen.common.logging.HeaderWarning;
import org.codelibs.fesen.common.logging.HeaderWarningAppender;
...
public abstract class ESTestCase extends LuceneTestCase {
    ...
    public void setHeaderWarningAppender() {
        ...
        Loggers.addAppender(LogManager.getLogger("org.codelibs.fesen.deprecation"), this.headerWarningAppender);
    }

    @After
    public void removeHeaderWarningAppender() {
        if (this.headerWarningAppender != null) {
            Loggers.removeAppender(LogManager.getLogger("org.codelibs.fesen.deprecation"), this.headerWarningAppender);
