...
public abstract class AbstractSerializingTestCase<T extends ToXContent & Writeable> extends AbstractWireSerializingTestCase<T> {
    ...
    /**
     * Whether or not to assert equivalence of the {@link org.codelibs.fesen.common.xcontent.XContent} of the test instance and the instance
     * parsed from the {@link org.codelibs.fesen.common.xcontent.XContent} of the test instance.
     *
