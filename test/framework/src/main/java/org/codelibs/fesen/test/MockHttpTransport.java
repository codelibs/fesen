...
public class MockHttpTransport extends AbstractLifecycleComponent implements HttpServerTransport {
    ...
    /**
     * Marker plugin used by {@link org.codelibs.fesen.node.MockNode} to enable {@link MockHttpTransport}.
     */
    ...
    private static final BoundTransportAddress DUMMY_BOUND_ADDRESS =
            new BoundTransportAddress(new TransportAddress[] { DUMMY_TRANSPORT_ADDRESS }, DUMMY_TRANSPORT_ADDRESS);
